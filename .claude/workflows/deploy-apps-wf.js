...
For EACH service, in this exact order, from a task worktree cut at origin/main (repos worktree add apps --name deploy-<name> --branch deploy/<name> --base origin/main — the sanctioned verb; never git worktree add by hand):
