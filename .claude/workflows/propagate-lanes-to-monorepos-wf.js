...
- Work ONLY in your own task worktree at ~/.hasna/repos/worktrees/<repo>/<worktree> created via the sanctioned verb (repos worktree add <repo> --name <worktree> --base origin/main; run repos scan after; never git worktree add by hand). Never the shared checkout, never main, never another agent's worktree.
...
1. OWN WORKTREE via hasna/repos: create ~/.hasna/repos/worktrees/<repo-name>/propagate-lanes from origin/main with the sanctioned verb (repos worktree add <repo-name> --name propagate-lanes --branch propagate/lanes-<target> --base origin/main; run repos scan after; never git worktree add by hand). Branch propagate/lanes-<target>. NEVER the shared checkout, never another agent's worktree.
