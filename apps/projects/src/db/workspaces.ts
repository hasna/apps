 ...
 * table. In the hosted backend the referenced project lives only in the hosted backend
 * registry, so a hosted id would violate the FK. The ledger is a machine-local
