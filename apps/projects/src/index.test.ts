...
describe("project-first SDK barrel", () => {
  test("exports project-named services and launch helpers", () => {
    ...
    expect(source).not.toContain("buildProjectCanvasPayload");
    expect(source).not.toContain("buildProjectCanvasesPayload");
    expect(source).not.toContain("PROJECT_RENDER_UI_CONTRACT");
