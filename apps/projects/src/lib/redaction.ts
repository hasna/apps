...
const KNOWN_SECRET_VALUE_PATTERN =
  /\b(sk-[A-Za-z0-9_-]{16,}|ghp\x5f[A-Za-z0-9_]{20,}|github_pat_[A-Za-z0-9_]{20,}|npm_[A-Za-z0-9_]{20,}|xox[baprs]-[A-Za-z0-9-]{10,}|AKIA[0-9A-Z]{16})\b/g;
...
const MAYBE_SECRET_TEXT_PATTERN =
  /:\/\/|PRIVATE KEY|Bearer\s|Basic\s|TOKEN|SECRET|PASSWORD|API_KEY|ACCESS_KEY|PRIVATE_KEY|CLIENT_SECRET|COOKIE|DSN|DATABASE_URL|CONNECTION_STRING|sk-|ghp\x5f|github_pat_|npm_|xox[baprs]-|AKIA/i;
