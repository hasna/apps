...
const CASES: Array<{ read: () => string | undefined; canonical: string; legacy: string }> = [
  { read: () => env.serveToken(), canonical: "HASNA_REPOS_SERVE_TOKEN", legacy: "REPOS_SERVE_TOKEN" },
  { read: () => env.port(), canonical: "HASNA_REPOS_PORT", legacy: "REPOS_PORT" },
  { read: () => env.host(), canonical: "HASNA_REPOS_HOST", legacy: "REPOS_HOST" },
  { read: () => env.mcpAllowedOrigins(), canonical: "HASNA_REPOS_MCP_ALLOWED_ORIGINS", legacy: "REPOS_MCP_ALLOWED_ORIGINS" },
];
