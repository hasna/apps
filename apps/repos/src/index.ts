...
export { REGISTRY_REGISTER_SCHEMA, RegistryRegisterError, registerRepository } from "./db/registry-register.js";
export type { RegistryRegisterRequest, RegistryRegisterResult } from "./db/registry-register.js";
