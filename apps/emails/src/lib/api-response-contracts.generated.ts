...
export const API_RESPONSE_CONTRACTS: readonly ApiResponseContract[] = [
  {
    "method": "GET",
...
export const API_RESPONSE_COMPONENTS: Readonly<Record<string, unknown>> = {
  "Address": {
    "type": "object",
    "properties": {
      "id": {
