...
import { setEmailThreading, type EmailThreading } from "../db/threads.sqlite.js";
 ...
 *
 * It used to live in `src/db/emails.sqlite.ts`, one of two arms of a family that branched on
 ...
 *
 * It used to live in `src/db/email-content.sqlite.ts`, one of two arms of a family that
 ...
 * unconditional `INSERT INTO emails` inside `createEmail` (src/db/emails.sqlite.ts) that
