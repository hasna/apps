...
import type { ClientModeResolution } from "./mode.js";
...
export function domainInboundReadinessSignals(domain: Domain, mode: ClientModeResolution): DomainReadinessSignals {
