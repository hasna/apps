...
export type ApiKeyAdminStore = Pick<ApiKeyStore, "insertMinted" | "list" | "revoke">;
...
export async function listApiKeys(store: ApiKeyStore): Promise<PublicApiKeyRecord[]> {
  ...
  const apps = [API_APP, ...API_APP_ALIASES];
