...
const SERVICE_STATUS_MATRIX: ReadonlyArray<readonly [string, string, readonly number[]]> = [
  ...
  // is the point of the route and is pinned rather than left to be noticed.
  ["/v1/messages/record", "post", [200, 201, 400, 401, 403, 413, 500]],
...
describe("api OpenAPI routine error-status parity", () => {
