// OpenAPI 3 description of the Emails api service (/v1).
//
...
import { API_RESOURCES, type ResourceColumn } from "./resources.js";
  ...
  properties: {
    ...
    policy_denial: {
      ...
      description:
        ...
        + "project it is enforced by src/server/api/policy-denial-visibility.test.ts, not by the wire contract.",
    },
    send_started_at: { type: "string", format: "date-time", nullable: true },
    created_at: { type: "string", format: "date-time" },
    updated_at: { type: "string", format: "date-time" },
...
// Both are CLAMPED, never rejected (src/server/api/store.ts clampLimit /
...
export const emailsApiOpenApi: EmailsOpenApiDocument = {
  openapi: "3.0.3",
  info: { title: "Emails Api API", version: "1.0.0" },
  ...
  paths: {
    ...
    "/v1/auth/providers": {
      get: {
        ...
        summary: "Report optional api sign-in providers",
        responses: {
          "200": {
            content: {
...
addRoutineErrorParity(emailsApiOpenApi);
