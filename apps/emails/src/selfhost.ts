...
export interface MessageListItem { "id": string; "direction": string; "from_addr": string; "to_addrs": Array<string>; "cc_addrs": Array<string>; "subject": string | null; "snippet": string | null; "status": string; "provider_id"?: string | null; "tags"?: Record<string, string> | null; "provider_message_id": string | null; "message_id": string | null; "in_reply_to": string | null; "thread_id"?: string | null; "received_at": string | null; "is_read": boolean; "is_starred": boolean; "labels": Array<string>; "attachment_count": number; "source_id": string | null; "send_state": string; "policy_denial"?: string | null; "send_started_at": string | null; "created_at": string; "updated_at": string }

export interface Message { "id": string; "direction": string; "from_addr": string; "to_addrs": Array<string>; "cc_addrs": Array<string>; "subject": string | null; "body_text": string | null; "body_html": string | null; "status": string; "provider_id"?: string | null; "tags"?: Record<string, string> | null; "provider_message_id": string | null; "message_id": string | null; "in_reply_to": string | null; "thread_id"?: string | null; "references"?: Array<string>; "received_at": string | null; "is_read": boolean; "is_starred": boolean; "labels": Array<string>; "headers": Record<string, unknown>; "attachments": Array<AttachmentMeta | null>; "source_id": string | null; "send_state": string; "send_started_at": string | null; "created_at": string; "updated_at": string }
