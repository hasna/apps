...
describe("createProvider", () => {
  ...
  it("REFUSES credentials instead of silently dropping them", () => {
    ...
    expect(() => createProvider({ name: "SES US", type: "ses", region: "us-east-1", access_key: "AKIA" + "EXAMPLE", secret_key: "s3cr3t" }))
  ...
  it("names the server-side environment variables the credentials belong in", () => {
    expect(() => createProvider({ name: "SES US", type: "ses", access_key: "AKIA" + "EXAMPLE", secret_key: "s3cr3t" }))
