...
function apiToDomain(e: Record<string, unknown>): Domain {
  ...
  return {
    ...
    inbound_status: e["provisioning_status"] === "inbound_ready" ? "ready" : "pending",
    outbound_status: e["status"] === "outbound_disabled" ? "disabled" : verified && e["status"] === "active" && ["ready", "active", "verified"].includes(String(e["provisioning_status"])) ? "ready" : "pending",
