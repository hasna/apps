...
const LEGACY_ENV_KEYS = [
  ...
  "HASNA_EMAILS_DB_PATH", "HASNA_EMAILS_LOCAL", "EMAILS_LOCAL", "HASNA_EMAILS_MODE", "EMAILS_CLIENT_ENV_SECRET",
  "HASNA_EMAILS_API_URL", "HASNA_EMAILS_API_KEY", "EMAILS_SELF_HOSTED_URL", "EMAILS_SELF_HOSTED_API_KEY",
