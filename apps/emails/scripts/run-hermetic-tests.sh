...
run_scrubbed() {
  ...
  env \
    ...
    -u HASNA_MAILERY_ENV_FILE \
    -u HASNA_EMAILS_DB_PATH -u EMAILS_DB_PATH \
    -u HASNA_EMAILS_DATABASE_URL \
    -u EMAILS_GMAIL_ACCESS_TOKEN -u EMAILS_GMAIL_API_ENDPOINT \
    -u HASNA_EMAILS_API_URL -u HASNA_EMAILS_API_KEY \
    -u EMAILS_SELF_HOSTED_HTTP_CONNECT_TIMEOUT \
    -u EMAILS_SELF_HOSTED_HTTP_TIMEOUT \
    -u EMAILS_SELF_HOSTED_HTTP_MAX_RESPONSE_BYTES \
    -u EMAILS_API_HTTP_CONNECT_TIMEOUT -u EMAILS_API_HTTP_TIMEOUT \
    -u EMAILS_API_HTTP_MAX_RESPONSE_BYTES \
    ...
    -u DATABASE_URL -u EMAILS_TEST_DATABASE_URL \
