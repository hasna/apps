...
HASNA_EMAILS_DATABASE_URL=<Secrets Manager injection; its presence is what selects
...
EMAILS_AUTH_FROM=<required for the API task; a sender identity verified in this account>
