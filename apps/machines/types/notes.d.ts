import { MACHINES_CONSUMER_CONTRACT_VERSION, getMachinesConsumerCapabilities, type MachineTopology, type MachineListPagination, type MachinesContractPackage } from "./topology.js";
...
export declare const LEGACY_NOTE_CONTEXT_SOURCES: readonly ["notes", "machines"];
