...
//
// This is the piece that makes `mode=cloud` real for a client. It sits on
...
// resolves to `cloud-http` (mode=cloud AND API_URL+API_KEY set), and
 ...
 * `name`; when it resolves to `cloud-http` (mode=cloud + API_URL +
