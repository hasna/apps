...
export function manifestInit(options: SdkMutationApprovalOptions = {}): string {
  assertSdkMutationApproved({
    operation: "machines_manifest_init",
...
export function manifestBootstrapCurrentMachine(options: SdkMutationApprovalOptions = {}): FleetManifest {
  assertSdkMutationApproved({
    operation: "machines_manifest_bootstrap",
...
export function runSetup(
  ...
  assertPlanApplyApproved("machines_setup_apply", plan, options);
...
export function runSync(
  ...
  assertPlanApplyApproved("machines_sync_apply", plan, options);
...
export function runClaudeInstall(
  ...
  assertPlanApplyApproved("machines_install_claude_apply", plan, options);
...
export function runTailscaleInstall(
  ...
  assertPlanApplyApproved("machines_install_tailscale_apply", plan, options);
...
export function addDomainMapping(
  ...
  assertSdkMutationApproved({
    operation: "machines_dns_add_domain_mapping",
...
export function runCertPlan(
  ...
  assertLocalApplyApproved("machines_cert_apply", `cert:${domains.join(",")}`, {
    domains,
    yes: options.yes === true,
  }, options);
...
export function runBackup(
  ...
  assertLocalApplyApproved("machines_backup_apply", `backup:${bucket ?? "env"}:${prefix ?? "default"}`, {
    bucket: bucket ?? null,
    prefix: prefix ?? null,
    yes: options.yes === true,
  }, options);
...
export function runDaemonServicePlan(
  ...
  if (options.apply === true) {
    assertSdkMutationApproved({
      operation: "machines_daemon_apply",
      machineId: "local",
...
export function writeNotificationConfig(
  ...
  assertSdkMutationApproved({
    operation: "machines_notifications_write_config",
...
export function addNotificationChannel(
  ...
  assertSdkMutationApproved({
    operation: "machines_notifications_add_channel",
...
export function removeNotificationChannel(
  ...
  assertSdkMutationApproved({
    operation: "machines_notifications_remove_channel",
...
export async function dispatchNotificationEvent(
  ...
  assertSdkMutationApproved({
    operation: "machines_notifications_dispatch",
...
export async function testNotificationChannel(
  ...
  if (options.apply === true) {
    assertSdkMutationApproved({
      operation: "machines_notifications_test_channel",
      resourceId: `notifications:channel:${channelId}`,
