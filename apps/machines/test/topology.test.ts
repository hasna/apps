...
import { discoverMachineTopology, getLocalMachineTopology, type TopologyCommandRunner } from "../src/topology.js";
...
describe("machine topology SDK", () => {
  test("merges manifest machines, heartbeats, and tailscale peers", () => {
    ...
    try {
      ...
      expect(spark01?.ssh.command_target).toBe("hasna@spark01.local");
