...
export const PROJECT_CONTEXT_MANIFEST_PATH = ".hasna/projects/project-context-manifest.json";
export const PROJECT_CONTEXT_CACHE_PATH = ".hasna/projects/project-context-cache.json";
export const PROJECT_CONTEXT_LOCK_PATH = ".hasna/projects/project-context.lock";
export const PROJECT_CONTEXT_SNAPSHOT_DIR = ".hasna/projects/project-context-snapshots";
