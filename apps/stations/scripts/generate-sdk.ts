#!/usr/bin/env bun
// Regenerate the typed SDK client from the stations-serve OpenAPI document.
//
...
const result = generateSdkFromOpenApi(spec, { className: "StationsClient", apiKeyHeader: "x-api-key" });
