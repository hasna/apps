...
export declare function resolveHttpSecurityConfig(env?: NodeJS.ProcessEnv, host?: string): MachinesHttpSecurityConfig;
export declare function isTrustedHttpOrigin(origin: string | undefined, host: string, allowedOrigins?: string[]): boolean;
export declare function authorizeHttpOrigin(req: IncomingMessage, host: string, security: MachinesHttpSecurityConfig): {
    ok: true;
} | {
    ok: false;
    status: 403;
...
export declare function authorizeHttpRequest(req: IncomingMessage, security: MachinesHttpSecurityConfig): {
    ok: true;
} | {
    ok: false;
    status: 401;
