...
import { MACHINES_CONSUMER_CONTRACT_VERSION, getMachinesConsumerCapabilities, type MachineRouteConfidence, type MachineRouteKind, type MachineTopology, type MachinesContractPackage } from "./topology.js";
...
export declare const BROWSERPLAN_ROUTE_OWNER = "machines";
