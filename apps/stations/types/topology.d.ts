...
export declare const STATIONS_CONSUMER_CONTRACT_VERSION = 1;
export declare const STATIONS_PACKAGE_NAME = "@hasna/stations";
export declare const STATIONS_CONSUMER_ENTRYPOINT = "@hasna/stations/consumer";
export declare const STATIONS_CONSUMER_SCHEMA_URI = "https://schemas.example.com/stations/consumer/v1/stations-consumer.schema.json";
export declare const STATIONS_CONSUMER_SCHEMA_ARTIFACT = "schemas/stations-consumer.schema.json";
...
export type StationsConsumerEnvelope = "topology" | "route" | "workspace" | "compatibility" | "resolver_snapshot" | "project_assignments" | "note_machine_context" | "machine_trash_policies" | "machine_details" | "browserplan_fleet" | "machine_health" | "routing" | "command_matrix" | "loop_preflight";
...
export declare const STATIONS_CONSUMER_CAPABILITIES: StationsConsumerCapabilities;
export declare const STATIONS_CONSUMER_FIELD_CAPABILITIES: StationsConsumerFieldCapabilities;
export declare const STATIONS_CONSUMER_CONTRACT: StationsConsumerContract;
export declare function getStationsConsumerCapabilities(): StationsConsumerCapabilities;
...
export type MachineResolverAuthority = "stations" | "manifest" | "manifest_metadata" | "live_topology" | "argument" | "inferred" | "fallback" | "unresolved" | "mixed" | "unknown";
