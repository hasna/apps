...
export declare const PRIVATE_METADATA_ENV = "HASNA_STATIONS_PRIVATE_METADATA";
export declare const PRIVATE_METADATA_FALLBACK_ENV = "STATIONS_PRIVATE_METADATA";
export declare const PRIVATE_OUTPUT_ENV = "HASNA_STATIONS_ALLOW_PRIVATE_OUTPUT";
export declare const PRIVATE_OUTPUT_FALLBACK_ENV = "STATIONS_ALLOW_PRIVATE_OUTPUT";
export declare const PRIVATE_OUTPUT_DENIED_WARNING = "private_output_denied:set HASNA_STATIONS_ALLOW_PRIVATE_OUTPUT=1 to allow private metadata output";
