...
export declare const SCREEN_SECRET_NAMESPACE_ENV = "HASNA_STATIONS_SCREEN_SECRET_NAMESPACE";
export declare const DEFAULT_SCREEN_SECRET_NAMESPACE = "stations/screen-sharing";
