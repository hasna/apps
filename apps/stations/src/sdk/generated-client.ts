...
// Source: Stations Control Plane API 0.0.63
...
export interface MachineList { "stations": Array<Machine>; "count": number }
...
export class StationsClient {
  ...
  constructor(options: StationsClientOptions) {
    if (!options.baseUrl) throw new Error("StationsClient requires a baseUrl.");
  ...
  private async request<T>(method: string, path: string, opts: { body?: unknown; query?: Record<string, unknown>; init?: RequestInit }): Promise<T> {
    ...
    async listStations(query?: { "status"?: string; "limit"?: number; "offset"?: number }, init?: RequestInit): Promise<MachineList> {
    ...
    async registerMachine(body: RegisterMachineRequest, init?: RequestInit): Promise<Machine> {
      return this.request("POST", `/v1/stations`, {
        body,
        query: undefined,
        init,
      });
    ...
    async getMachine(id: string, init?: RequestInit): Promise<Machine> {
      return this.request("GET", `/v1/stations/${encodeURIComponent(String(id))}`, {
        body: undefined,
        query: undefined,
        init,
      });
    ...
    async deleteMachine(id: string, init?: RequestInit): Promise<DeleteResult> {
      return this.request("DELETE", `/v1/stations/${encodeURIComponent(String(id))}`, {
        body: undefined,
        query: undefined,
        init,
      });
    ...
    async updateMachine(id: string, body: UpdateMachineRequest, init?: RequestInit): Promise<Machine> {
      return this.request("PATCH", `/v1/stations/${encodeURIComponent(String(id))}`, {
        body,
        query: undefined,
        init,
      });
