// Cloud-mode (Amendment A1 PURE REMOTE) schema for the stations control-plane
// registry service. These migrations run against the shared RDS `stations`
...
/**
 * Ordered migrations for the stations cloud database.
 *
 ...
 * ones.
 */
export const STATIONS_MIGRATIONS: readonly Migration[] = [
  defineMigration(
    "stations_0001_registry",
    `CREATE TABLE IF NOT EXISTS stations (
     ...
     CREATE INDEX IF NOT EXISTS stations_updated_at_idx ON stations (updated_at DESC);`,
  ),
  defineMigration(
    "stations_0002_agent_heartbeats",
