// OpenAPI 3.1 description of the stations control-plane serve API.
//
...
export function buildOpenApiDocument(version: string = getPackageVersion()): Record<string, unknown> {
  ...
  return {
    openapi: "3.1.0",
    info: {
      title: "Stations Control Plane API",
      version,
      description:
        ...
        "the shared RDS stations database directly (Amendment A1, PURE REMOTE).",
    },
    ...
    components: {
      ...
      schemas: {
        ...
        MachineList: {
          ...
          properties: {
            stations: { type: "array", items: { $ref: "#/components/schemas/Machine" } },
            count: { type: "integer" },
          },
        },
        HeartbeatList: {
