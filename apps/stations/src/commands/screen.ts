...
export const SCREEN_SECRET_NAMESPACE_ENV = "HASNA_STATIONS_SCREEN_SECRET_NAMESPACE";
export const DEFAULT_SCREEN_SECRET_NAMESPACE = "stations/screen-sharing";
...
export function screenCredentialsFailed(
  ...
  // Non-strict: unroutable stations are informational as long as at least one machine
