...
export const PRIVATE_METADATA_ENV = "HASNA_STATIONS_PRIVATE_METADATA";
export const PRIVATE_METADATA_FALLBACK_ENV = "STATIONS_PRIVATE_METADATA";
export const PRIVATE_OUTPUT_ENV = "HASNA_STATIONS_ALLOW_PRIVATE_OUTPUT";
export const PRIVATE_OUTPUT_FALLBACK_ENV = "STATIONS_ALLOW_PRIVATE_OUTPUT";
