...
describe("install-claude", () => {
  afterEach(() => {
    delete process.env["HASNA_STATIONS_CLAUDE_BINARY"];
    delete process.env["HASNA_STATIONS_CODEX_BINARY"];
    delete process.env["HASNA_STATIONS_GEMINI_BINARY"];
  ...
  test("reports CLI status and diff using runtime binary overrides", () => {
    process.env["HASNA_STATIONS_MACHINE_ID"] = "demo-node-01";
    process.env["HASNA_STATIONS_CLAUDE_BINARY"] = "sh";
    process.env["HASNA_STATIONS_CODEX_BINARY"] = "__missing_codex__";
    process.env["HASNA_STATIONS_GEMINI_BINARY"] = "__missing_gemini__";
  ...
  test("surfaces remote command failures instead of reporting tools missing", () => {
    process.env["HASNA_STATIONS_MACHINE_ID"] = "remote-fixture";
