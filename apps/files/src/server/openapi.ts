  ...
  paths: {
    ...
    "/knowledge/manifest": {
      get: {
        ...
        parameters: [
          { name: "source_id", in: "query", schema: { type: "string", minLength: 1 } },
          { name: "collection_id", in: "query", schema: { type: "string", minLength: 1 } },
          { name: "project_id", in: "query", schema: { type: "string", minLength: 1 } },
          { name: "tag", in: "query", schema: { type: "string", minLength: 1 } },
