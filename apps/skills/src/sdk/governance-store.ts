 ...
 *
 * The SQLite implementation and the database-target factory
 * (`createGovernanceStore`) live in `src/server/sqlite-governance-store.ts`:
 * the published `./sdk` surface opens no SQLite (fail-closed re-cut, owner
 * ruling 2026-09-07 / hasna/apps#1720).
 */
...
export const EXPIRED_ARTIFACT_SQL = `
