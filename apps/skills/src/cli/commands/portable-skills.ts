...
export function registerPortableSkillCommands(parent: Command) {
  parent
    ...
    .description("Scaffold a portable skill into the canonical corpus (<app folder>/installed/<name>, or <app folder>/skills/<name> after the owner-layout migration)")
  ...
  parent
    ...
    .option("--json", "Output result as JSON", false)
    .description("Import an existing skill folder into the canonical corpus (<app folder>/installed/<name>, or <app folder>/skills/<name> after the owner-layout migration)")
