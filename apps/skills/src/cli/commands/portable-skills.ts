...
export function registerPortableSkillCommands(parent: Command) {
  parent
    ...
    .description("Scaffold a portable skill under <skills data root>/installed/<name>")
  ...
  parent
    ...
    .option("--json", "Output result as JSON", false)
    .description("Import an existing skill folder into <skills data root>/installed/<name>")
