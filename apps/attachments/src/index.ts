...
// they default to an on-box sqlite DB and never consult the hosted-API env, so
// exposing them lets a consumer write to local sqlite even when
// HASNA_ATTACHMENTS_API_URL/KEY are set — exactly the split-brain bug this
// package's Store abstraction kills.
...
export type { Store, ListOptions, LinkResult, RegenerateLinkOptions, UploadOptions, FeedbackInput } from "./core/store.js";
