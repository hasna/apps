...
When creation or runtime preflight is enabled, OpenLoops verifies it with
`codewith profile list`, accepting both normal rows and the active `*`-marked
row by exact profile name.
