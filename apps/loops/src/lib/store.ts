...
let localStoreOpenNotice: (() => void) | null = null;

/** Install a process-owned notice that fires immediately before an allowed local open. */
export function setLocalStoreOpenNoticeForProcess(notice: () => void): void {
  localStoreOpenNotice = notice;
}
