...
export const ROUTE_POLICIES: readonly RoutePolicy[] = Object.freeze([
  ...
  policy("workflowRuns.cancel", "POST", "/v1/workflow-runs/{id}/cancel", /^\/v1\/workflow-runs\/[^/]+\/cancel$/, ["loops:write"], ADMIN_ROLES, ["api_key", "service"], "write"),
  ...
  policy("workItems.requeue", "POST", "/v1/work-items/{id}/requeue", /^\/v1\/work-items\/[^/]+\/requeue$/, ["loops:write"], ADMIN_ROLES, ["api_key", "service"], "write"),
