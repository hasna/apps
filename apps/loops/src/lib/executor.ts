...
export type BundleExecutionDecision =
  | { target: ExecutableTarget; opts: ExecuteOptions; bundle?: RunReceiptBundle }
 ...
 */
export function bundleRefusalResult(refusal: BundleExecutionRefusal): ExecutorResult {
  return failureResult(nowIso(), `${refusal.error}: ${refusal.message}`);
}

export function applyBundleExecution(loop: Loop, opts: ExecuteOptions): BundleExecutionDecision {
