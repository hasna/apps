...
// conformance checks (manifest_valid, bins_allowlisted, bins_match_package,
// server_backend_configuration, health_shape, no_cloud_guard) — BUILD-SPEC §4.5.
...
describe("hasna.service_contract.v1 conformance", () => {
  it("passes all repo-conformance checks", () => {
    ...
    for (const id of ["manifest_valid", "bins_allowlisted", "bins_match_package", "server_backend_configuration", "health_shape", "no_cloud_guard"]) {
