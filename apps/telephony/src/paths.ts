 ...
 * platform placement (`the telephony data root` on macOS, XDG data root on Linux)
 ...
 * `the telephony data root` on macOS, `~/.local/share/hasna/telephony` on Linux.
 */
...
/**
 * The pre-ruling legacy root (`the telephony data root`). On macOS this equals the
