...
- a6a85e7: Add authenticated raw fetch for SDK response streams and downloads, preserving the shared authority and credential binding without response parsing or automatic retries.
...
- 653f79e: Declare the `@hasna/secrets` peer as `^0.3.10` rather than an exact `0.3.10`.
