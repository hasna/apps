// Test isolation for the testers suite.
//
// The client store is selected by the env contract alone: HASNA_TESTERS_API_URL
// + HASNA_TESTERS_API_KEY both set -> hosted API, otherwise local SQLite. CI
// runs with a clean environment, but a machine whose fleet env-flip points
// testers at the hosted API would otherwise route the whole local-isolation
