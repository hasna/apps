...
export interface Store {
   ...
   * transport ONLY — the ApiStore rejects this because a hosted dataset cannot
   * be dumped to a client-side file; sandbox provisioning against the hosted API
   * must hand the sandbox API credentials instead.
   */
