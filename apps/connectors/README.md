...
- credentials live in the connectors data home (resolved by the in-package resolver; `~/.hasna/connectors/` until the XDG data home is adopted)
...
- `connectors auth` stores credentials in the connectors data home (resolved by the in-package resolver)
