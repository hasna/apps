...
import {
  createJob, listJobs, getJobByName, updateJob, deleteJob, listJobRuns,
} from "../../db/jobs.js";
...
export function registerCommands(program: Command): void {
  ...
  jobsCmd
    ...
    .action((options) => {
      ...
      if (options.json) { console.log(JSON.stringify(jobs)); return; }
  ...
  workflowsCmd
    ...
    .action((options) => {
      ...
      if (options.json) { console.log(JSON.stringify(wfs)); return; }
