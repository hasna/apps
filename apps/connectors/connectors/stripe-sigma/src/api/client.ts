...
/** Sigma query runs require a preview Stripe API version. */
const DEFAULT_API_VERSION = '2025-06-30.preview';
...
export class ConnectorClient {
  ...
  constructor(config: ConnectorConfig) {
    ...
    if (this.apiKey.startsWith('sk_org_') && !this.accountId) {
      throw new Error(
        'Account ID is required for organization API keys. Use config set-account or STRIPE_SIGMA_ACCOUNT_ID.',
      );
    }
  }
