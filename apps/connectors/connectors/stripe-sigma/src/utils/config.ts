...
export function getApiKey(): string | undefined {
  return process.env.STRIPE_SIGMA_API_KEY || process.env.STRIPE_API_KEY || loadProfile().apiKey;
}
...
export function getAccountId(): string | undefined {
  return process.env.STRIPE_SIGMA_ACCOUNT_ID || process.env.STRIPE_ACCOUNT_ID || loadProfile().accountId;
}
...
export function getApiVersion(): string | undefined {
  return process.env.STRIPE_SIGMA_API_VERSION || process.env.STRIPE_API_VERSION || loadProfile().apiVersion;
}
