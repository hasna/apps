...
export function getApiKey(): string | undefined {
  return process.env.WORKABLE_API_TOKEN || loadProfile().apiKey || loadProfile().token;
}
...
export function getSubdomain(): string | undefined {
  return process.env.WORKABLE_SUBDOMAIN || loadProfile().subdomain;
}
...
export function getToken(): string | undefined {
  return process.env.WORKABLE_API_TOKEN || loadProfile().token || loadProfile().apiKey;
}
