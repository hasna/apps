...
export function getApiKey(): string | undefined {
  return process.env.VERCEL_API_PLATFORM_API_KEY || loadProfile().apiKey || loadProfile().token;
}
...
export function getBaseUrl(): string | undefined {
  return process.env.VERCEL_API_PLATFORM_BASE_URL || loadProfile().baseUrl;
}
