...
// Store config in ~/.hasna/connectors/connect-googlephotos/ (always in home directory)
...
export function getAccessToken(): string | undefined {
  return process.env.GOOGLE_PHOTOS_ACCESS_TOKEN || loadTokens()?.accessToken;
}

export function getRefreshToken(): string | undefined {
  return process.env.GOOGLE_PHOTOS_REFRESH_TOKEN || loadTokens()?.refreshToken;
}
