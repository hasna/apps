...
// NOTE: As of March 31, 2025, Google deprecated broad scopes (photoslibrary.readonly,
// photoslibrary.sharing, photoslibrary). Apps can now only access content they created.
const PHOTOS_SCOPES = [
  'https://www.googleapis.com/auth/photoslibrary.appendonly', // Upload and create content
  'https://www.googleapis.com/auth/photoslibrary.readonly.appcreateddata', // Read app-created content
  'https://www.googleapis.com/auth/photoslibrary.edit.appcreateddata', // Edit app-created content
  'https://www.googleapis.com/auth/userinfo.email', // Get user email
].join(' ');

const REDIRECT_PORT = 8090; // Different port from Gmail connector
