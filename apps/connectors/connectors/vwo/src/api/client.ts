...
const DEFAULT_BASE_URL = 'https://app.vwo.com/api/v2';
...
export class ConnectorClient {
  ...
  async get<T>(path: string, params?: object): Promise<T> {
    return this.request<T>(path, { method: 'GET', params: params as QueryParams });
  }

  async post<T>(path: string, body?: object | string, params?: object): Promise<T> {
  ...
  async patch<T>(path: string, body?: object, params?: object): Promise<T> {
    return this.request<T>(path, {
      method: 'PATCH',
      body: body as Record<string, unknown>,
      params: params as QueryParams,
  ...
  async delete<T>(path: string, params?: object): Promise<T> {
    return this.request<T>(path, { method: 'DELETE', params: params as QueryParams });
  }
