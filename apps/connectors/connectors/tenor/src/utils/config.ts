...
export interface ProfileConfig {
  ...
  apiSecret?: string;
  clientKey?: string;   // Optional Tenor client_key
...
export function getApiKey(): string | undefined {
  return process.env.TENOR_API_KEY || loadProfile().apiKey;
}
...
export function getApiSecret(): string | undefined {
  return process.env.TENOR_API_SECRET || loadProfile().apiSecret;
}

/**
 * Get the optional Tenor client key (identifies the integration).
 */
export function getClientKey(): string | undefined {
  return process.env.TENOR_CLIENT_KEY || loadProfile().clientKey;
}

export function setClientKey(clientKey: string): void {
  const config = loadProfile();
...
export function getToken(): string | undefined {
  return process.env.TENOR_TOKEN || process.env.TENOR_API_KEY || loadProfile().token || loadProfile().apiKey;
}
