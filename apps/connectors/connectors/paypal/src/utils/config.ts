...
export function getClientId(): string | undefined {
  return process.env.PAYPAL_CLIENT_ID || loadProfile().clientId;
}
...
export function getClientSecret(): string | undefined {
  return process.env.PAYPAL_CLIENT_SECRET || loadProfile().clientSecret;
}
...
export function getBaseUrl(): string | undefined {
  return process.env.PAYPAL_BASE_URL || loadProfile().baseUrl;
}
