...
// Config directory: ~/.hasna/connectors/specific/
...
// ============================================
// API Key Management
// Specific uses a personal API key (SPECIFIC_API_KEY)
// ============================================

export function getApiKey(): string | undefined {
  return process.env.SPECIFIC_API_KEY || loadProfile().apiKey;
}
...
export function getBaseUrl(): string | undefined {
  return process.env.SPECIFIC_BASE_URL || loadProfile().baseUrl;
}
