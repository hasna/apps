...
export function getApiKey(): string | undefined {
  return process.env.ACTIVETRAIL_API_KEY || loadProfile().apiKey;
}
...
export function getApiSecret(): string | undefined {
  return process.env.ACTIVETRAIL_API_SECRET || loadProfile().apiSecret;
}
...
export function getToken(): string | undefined {
  return process.env.ACTIVETRAIL_TOKEN || process.env.ACTIVETRAIL_API_KEY || loadProfile().token || loadProfile().apiKey;
}
