...
export function getApiToken(): string | undefined {
  return process.env.TEXTIT_API_TOKEN || loadProfile().apiToken;
}
...
export function getBaseUrl(): string | undefined {
  return process.env.TEXTIT_BASE_URL || loadProfile().baseUrl;
}

export function getTokenPrefix(): string | undefined {
  return process.env.TEXTIT_TOKEN_PREFIX || loadProfile().tokenPrefix;
}
