...
const CONNECTOR_NAME = 'connect-zohorecruit';
const ENV_TOKEN = 'ZOHORECRUIT_TOKEN';
const ENV_DATA_CENTER = 'ZOHORECRUIT_DATA_CENTER';
const ENV_BASE_URL = 'ZOHORECRUIT_BASE_URL';
...
export function getDataCenter(): string | undefined {
  return process.env[ENV_DATA_CENTER] || loadProfile().dataCenter;
}
...
export function getBaseUrl(): string | undefined {
  return process.env[ENV_BASE_URL] || loadProfile().baseUrl;
}
...
export function getAccessToken(): string | undefined {
  return process.env[ENV_TOKEN] || loadProfile().accessToken || loadProfile().token;
}
