...
API connector for nanonetsocr with multi-profile support.
...
git clone https://github.com/hasnaxyz/scaffold-connector.git connect-yourapi
cd connect-yourapi

# Update package.json name
# Change "@hasnaxyz/scaffold-connector" to "@hasnaxyz/connect-yourapi"
```
