...
const CONNECTOR_NAME = 'connect-supabase';
...
export function getProjectUrl(): string | undefined {
  return process.env.SUPABASE_URL || process.env.SUPABASE_PROJECT_URL || loadProfile().projectUrl;
}

export function setProjectUrl(projectUrl: string): void {
...
export function getServiceRoleKey(): string | undefined {
  return process.env.SUPABASE_SERVICE_ROLE_KEY || process.env.SUPABASE_SERVICE_KEY || loadProfile().serviceRoleKey;
}

export function setServiceRoleKey(serviceRoleKey: string): void {
  const config = loadProfile();
...
export function getAnonKey(): string | undefined {
  return process.env.SUPABASE_ANON_KEY || process.env.SUPABASE_KEY || loadProfile().anonKey;
}

export function setAnonKey(anonKey: string): void {
  const config = loadProfile();
