...
// Coinbase connector configuration
...
export function getApiKey(): string | undefined {
  return process.env.COINBASE_API_KEY || loadProfile().apiKey;
}
...
export function getApiSecret(): string | undefined {
  return process.env.COINBASE_API_SECRET || loadProfile().apiSecret;
}
...
export function getBaseUrl(): string | undefined {
  return process.env.COINBASE_BASE_URL || loadProfile().baseUrl;
}
