...
export function getApiKey(): string | undefined {
  return process.env.DATADOG_API_KEY || loadProfile().apiKey;
}
...
export function getAppKey(): string | undefined {
  return process.env.DATADOG_APP_KEY || loadProfile().appKey;
}
...
export function getSite(): string | undefined {
  return process.env.DATADOG_SITE || loadProfile().site;
}
