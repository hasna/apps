...
import { YouSearchApiError } from '../types';

export const DEFAULT_BASE_URL = 'https://api.you.com';
...
export class YouSearchClient {
  ...
  /**
   * Make an authenticated request to the You.com API
   */
  async request<T>(path: string, options: RequestOptions = {}): Promise<T> {
    ...
    if (!response.ok) {
      ...
      throw new YouSearchApiError(errorMessage, response.status);
    }
