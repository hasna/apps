...
export interface ProfileConfig {
  accessToken?: string;
  baseUrl?: string; // Self-hosted GitLab URL
}
...
export function getAccessToken(): string | undefined {
  return process.env.GITLAB_ACCESS_TOKEN || process.env.GITLAB_TOKEN || loadProfile().accessToken;
}
...
export function getBaseUrl(): string | undefined {
  return process.env.GITLAB_URL || loadProfile().baseUrl;
}
