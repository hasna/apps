...
export function getToken(): string | undefined {
  return process.env.ZOHOINVENTORY_TOKEN || loadProfile().token;
}
...
export function getOrganizationId(): string | undefined {
  return process.env.ZOHOINVENTORY_ORG_ID || loadProfile().organizationId;
}
...
export function getBaseUrl(): string | undefined {
  return process.env.ZOHOINVENTORY_BASE_URL || loadProfile().baseUrl;
}
