...
export function getEmail(): string | undefined {
  return process.env.TESTRAIL_EMAIL || loadProfile().email;
}
...
export function getApiKey(): string | undefined {
  return process.env.TESTRAIL_API_KEY || loadProfile().apiKey;
}
...
export function getBaseUrl(): string | undefined {
  return process.env.TESTRAIL_BASE_URL || loadProfile().baseUrl;
}
