...
export function getClientId(): string | undefined {
  return process.env.SNOV_IO_CLIENT_ID || loadProfile().clientId;
}
...
export function getClientSecret(): string | undefined {
  return process.env.SNOV_IO_CLIENT_SECRET || loadProfile().clientSecret;
}
...
export function getBaseUrl(): string | undefined {
  return process.env.SNOV_IO_BASE_URL || loadProfile().baseUrl;
}
