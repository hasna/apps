...
export function getToken(): string | undefined {
  return (
    process.env.ZOHOPROJECTS_TOKEN ||
...
export function getPortalId(): string | undefined {
  return process.env.ZOHOPROJECTS_PORTAL_ID || loadProfile().portalId;
}
...
export function getDataCenter(): string | undefined {
  return process.env.ZOHOPROJECTS_DATA_CENTER || loadProfile().dataCenter;
}
...
export function getBaseUrl(): string | undefined {
  return process.env.ZOHOPROJECTS_BASE_URL || loadProfile().baseUrl;
}
...
export function getAccessToken(): string | undefined {
  return loadProfile().accessToken || loadProfile().token;
}
