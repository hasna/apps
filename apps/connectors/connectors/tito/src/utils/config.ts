...
export function getApiKey(): string | undefined {
  return process.env.TITO_API_TOKEN || loadProfile().apiKey;
}
...
export function getApiSecret(): string | undefined {
  return process.env.TITO_API_SECRET || loadProfile().apiSecret;
}
...
export function getToken(): string | undefined {
  return process.env.TITO_API_TOKEN || loadProfile().token || loadProfile().apiKey;
}
