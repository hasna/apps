...
// ============================================
// Smile.io Credentials Management
// Environment variables always take precedence over stored profile values.
// ============================================

export function getApiKey(): string | undefined {
  return process.env.SMILEIO_API_KEY || loadProfile().apiKey;
}
...
export function getBaseUrl(): string | undefined {
  return process.env.SMILEIO_BASE_URL || loadProfile().baseUrl;
}
