...
import { clearAuthToken, getConfigDir, setCredentials } from '../utils/config';
...
describe('Toast config', () => {
  test('stores credential profiles with private permissions', () => {
    setCredentials('client-id', 'client-secret');

    const configDir = getConfigDir();
    const profilesDir = `${configDir}/profiles`;
    const profilePath = `${profilesDir}/default.json`;
