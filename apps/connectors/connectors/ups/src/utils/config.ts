...
export function getApiKey(): string | undefined {
  return process.env.UPS_API_KEY || loadProfile().apiKey || loadProfile().token;
}

export function getBaseUrl(): string | undefined {
  return process.env.UPS_BASE_URL || loadProfile().baseUrl;
}
...
export function getToken(): string | undefined {
  return process.env.UPS_API_KEY || loadProfile().token || loadProfile().apiKey;
}
