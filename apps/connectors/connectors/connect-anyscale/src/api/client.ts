import { AnyscaleApiError, type AnyscaleConfig, type ChatRequest, type ChatResponse, type ModelsResponse } from '../types';

const DEFAULT_BASE_URL = 'https://api.endpoints.anyscale.com/v1';

export class AnyscaleClient {
  ...
  private async request<T>(
    ...
    if (!response.ok) {
      ...
      throw new AnyscaleApiError(errorMessage, response.status);
    }
