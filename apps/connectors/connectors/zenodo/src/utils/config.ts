...
export function getAccessToken(): string | undefined {
  return process.env.ZENODO_ACCESS_TOKEN || loadProfile().accessToken;
}
...
export function getBaseUrl(): string {
  return process.env.ZENODO_BASE_URL || loadProfile().baseUrl || DEFAULT_BASE_URL;
}
...
export function buildConnectorConfig(): { accessToken?: string; baseUrl: string } {
  return {
