...
export function getApiKey(): string | undefined {
  return process.env.VELUM_DATA_QUALITY_API_KEY || loadProfile().apiKey;
}

export function getBaseUrl(): string | undefined {
  return process.env.VELUM_DATA_QUALITY_BASE_URL || loadProfile().baseUrl;
}
...
export function getApiSecret(): string | undefined {
  return process.env.VELUM_DATA_QUALITY_API_SECRET || loadProfile().apiSecret;
}
...
export function getToken(): string | undefined {
  return process.env.VELUM_DATA_QUALITY_TOKEN || process.env.VELUM_DATA_QUALITY_API_KEY || loadProfile().token || loadProfile().apiKey;
}
