...
export function getApiKey(): string | undefined {
  return process.env.USPS_API_KEY || process.env.CONNECTOR_API_KEY || loadProfile().apiKey;
}
...
export function getBaseUrl(): string | undefined {
  return process.env.USPS_BASE_URL || process.env.CONNECTOR_BASE_URL;
}
...
export function getToken(): string | undefined {
  return process.env.USPS_API_KEY || process.env.CONNECTOR_TOKEN || process.env.CONNECTOR_API_KEY || loadProfile().token || loadProfile().apiKey;
}
