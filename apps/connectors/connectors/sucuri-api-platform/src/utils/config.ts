...
export function getApiKey(): string | undefined {
  return process.env.SUCURI_API_PLATFORM_API_KEY || loadProfile().apiKey;
}

export function getBaseUrl(): string | undefined {
  return process.env.SUCURI_API_PLATFORM_BASE_URL || loadProfile().baseUrl;
}
...
export function getToken(): string | undefined {
  return process.env.SUCURI_API_PLATFORM_API_KEY || loadProfile().token || loadProfile().apiKey;
}
