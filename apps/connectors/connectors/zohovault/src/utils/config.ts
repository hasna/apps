...
const CONNECTOR_NAME = 'zohovault';
...
export function getDataCenter(): string {
  return process.env.ZOHOVAULT_DATA_CENTER || loadProfile().dataCenter || 'com';
}
...
export function getBaseUrl(): string | undefined {
  return process.env.ZOHOVAULT_BASE_URL || loadProfile().baseUrl;
}
