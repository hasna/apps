...
export function getApiKey(): string | undefined {
  return process.env.ABSTRACT_API_KEY || loadProfile().apiKey;
}
...
export function getApiSecret(): string | undefined {
  return process.env.ABSTRACT_API_SECRET || loadProfile().apiSecret;
}
...
export function getToken(): string | undefined {
  return process.env.ABSTRACT_TOKEN || process.env.ABSTRACT_API_KEY || loadProfile().token || loadProfile().apiKey;
}
