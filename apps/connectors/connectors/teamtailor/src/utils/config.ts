...
const CONNECTOR_NAME = 'connect-teamtailor';
...
// Config directory: ~/.hasna/connectors/connect-teamtailor/
...
export function getApiKey(): string | undefined {
  return process.env.TEAMTAILOR_API_KEY || loadProfile().apiKey;
}
...
export function getApiVersion(): string | undefined {
  return process.env.TEAMTAILOR_API_VERSION || loadProfile().apiVersion;
}
...
export function getBaseUrl(): string | undefined {
  return process.env.TEAMTAILOR_BASE_URL || loadProfile().baseUrl;
}
