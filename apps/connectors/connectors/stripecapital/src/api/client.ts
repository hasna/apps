...
// Stripe API base URL (Capital lives under /v1/capital)
 ...
 * Stripe uses bracket notation: metadata[key]=value, created[gte]=123
 */
...
export class ConnectorClient {
  ...
  async request<T>(path: string, options: RequestOptions = {}): Promise<T> {
    ...
    // Act on behalf of a connected account (Capital for platforms).
    if (this.accountId) {
