...
// Stripe Capital connector name
const CONNECTOR_NAME = 'stripecapital';
...
export function getApiKey(): string | undefined {
  return process.env.STRIPE_CAPITAL_API_KEY || loadProfile().apiKey;
}
...
export function getAccountId(): string | undefined {
  return process.env.STRIPE_CAPITAL_ACCOUNT_ID || loadProfile().accountId;
}
