...
// Config directory: ~/.hasna/connectors/connect-smtp2go/
...
export function getApiKey(): string | undefined {
  return process.env.SMTP2GO_API_KEY || loadProfile().apiKey;
}
...
export function getBaseUrl(): string | undefined {
  return process.env.CONNECTOR_BASE_URL || loadProfile().baseUrl;
}
