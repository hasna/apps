...
export function getApiKey(): string | undefined {
  return process.env.STRIPE_BILLING_ADVANCED_API_KEY || loadProfile().apiKey;
}
...
export function getApiVersion(): string | undefined {
  return process.env.STRIPE_BILLING_ADVANCED_API_VERSION || loadProfile().apiVersion;
}
...
export function getBaseUrl(): string | undefined {
  return process.env.STRIPE_BILLING_ADVANCED_BASE_URL || loadProfile().baseUrl;
}
