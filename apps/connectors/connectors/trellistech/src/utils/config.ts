...
export function getApiKey(): string | undefined {
  return process.env.TRELLISTECH_API_KEY || process.env.CONNECTOR_API_KEY || loadProfile().apiKey;
}

export function getWorkspaceId(): string | undefined {
  return process.env.TRELLISTECH_WORKSPACE_ID || loadProfile().workspaceId;
}
