...
export function getApiKey(): string | undefined {
  return process.env.STRIPE_FINANCIAL_CONNECTIONS_API_KEY || loadProfile().apiKey;
}
...
export function getBaseUrl(): string | undefined {
  return process.env.STRIPE_FINANCIAL_CONNECTIONS_BASE_URL || loadProfile().baseUrl;
}
