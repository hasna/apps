...
export function getApiKey(): string | undefined {
  return process.env.ADALO_API_KEY || loadProfile().apiKey;
}
...
export function getApiSecret(): string | undefined {
  return process.env.ADALO_API_SECRET || loadProfile().apiSecret;
}
...
export function getToken(): string | undefined {
  return process.env.ADALO_TOKEN || process.env.ADALO_API_KEY || loadProfile().token || loadProfile().apiKey;
}
