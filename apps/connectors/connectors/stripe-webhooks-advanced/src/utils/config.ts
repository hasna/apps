...
const CONNECTOR_NAME = 'stripe-webhooks-advanced';
...
export function getApiKey(): string | undefined {
  return process.env.STRIPE_WEBHOOKS_ADVANCED_API_KEY || loadProfile().apiKey;
}
...
export function getApiSecret(): string | undefined {
  return process.env.STRIPE_WEBHOOKS_ADVANCED_API_SECRET || loadProfile().apiSecret;
}
...
export function getAccountId(): string | undefined {
  return process.env.STRIPE_WEBHOOKS_ADVANCED_ACCOUNT_ID || loadProfile().accountId;
}
...
export function getBaseUrl(): string | undefined {
  return process.env.STRIPE_WEBHOOKS_ADVANCED_BASE_URL || loadProfile().baseUrl;
}
