...
export interface ProfileConfig {
  accessId?: string;
  accessKey?: string;
  deployment?: string; // us1, us2, eu, au, ca, de, jp, in, fed
  endpoint?: string; // fully-qualified endpoint override
}
...
export function getAccessId(): string | undefined {
  return process.env.SUMOLOGIC_ACCESS_ID || loadProfile().accessId;
}

export function setAccessId(accessId: string): void {
...
export function getAccessKey(): string | undefined {
  return process.env.SUMOLOGIC_ACCESS_KEY || loadProfile().accessKey;
}
...
export function getDeployment(): string | undefined {
  return process.env.SUMOLOGIC_DEPLOYMENT || loadProfile().deployment;
}

export function setDeployment(deployment: string): void {
  const config = loadProfile();
...
export function getEndpoint(): string | undefined {
  return process.env.SUMOLOGIC_ENDPOINT || loadProfile().endpoint;
}
