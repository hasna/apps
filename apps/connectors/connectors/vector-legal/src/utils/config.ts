...
export function getApiKey(): string | undefined {
  return process.env.VECTOR_LEGAL_API_KEY || loadProfile().apiKey;
}

export function getBaseUrl(): string | undefined {
  return process.env.VECTOR_LEGAL_BASE_URL || loadProfile().baseUrl;
}
...
export function getApiSecret(): string | undefined {
  return process.env.VECTOR_LEGAL_API_SECRET || loadProfile().apiSecret;
}
...
export function getToken(): string | undefined {
  return process.env.VECTOR_LEGAL_TOKEN || process.env.VECTOR_LEGAL_API_KEY || loadProfile().token || loadProfile().apiKey;
}
