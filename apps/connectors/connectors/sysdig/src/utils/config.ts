...
export interface ProfileConfig {
  ...
  baseUrl?: string; // on-prem / custom base URL (overrides region)
}
...
export function getApiToken(): string | undefined {
  return process.env.SYSDIG_API_TOKEN || loadProfile().apiToken;
}
...
export function getRegion(): string | undefined {
  return process.env.SYSDIG_REGION || loadProfile().region;
}
...
export function getBaseUrl(): string | undefined {
  return process.env.SYSDIG_BASE_URL || loadProfile().baseUrl;
}
