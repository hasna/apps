...
export function getApiKey(): string | undefined {
  return process.env.SMOL_MACHINES_API_KEY || loadProfile().apiKey;
}

export function getBaseUrl(): string | undefined {
  return process.env.SMOL_MACHINES_BASE_URL || loadProfile().baseUrl;
}
...
export function getConnectorConfig(): ProfileConfig {
  return {
    apiKey: getApiKey(),
    baseUrl: getBaseUrl(),
  };
