...
export function getClientId(): string | undefined {
  return process.env.PLAID_CLIENT_ID || loadProfile().clientId;
}
...
export function getSecret(): string | undefined {
  return process.env.PLAID_SECRET || loadProfile().secret;
}
...
export function getBaseUrl(): string | undefined {
  return process.env.PLAID_BASE_URL || loadProfile().baseUrl;
}
