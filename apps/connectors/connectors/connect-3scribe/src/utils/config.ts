...
export function getApiKey(): string | undefined {
  return process.env.THREESCRIBE_API_KEY || loadProfile().apiKey;
}
...
export function getApiSecret(): string | undefined {
  return process.env.THREESCRIBE_API_SECRET || loadProfile().apiSecret;
}
...
export function getToken(): string | undefined {
  return process.env.THREESCRIBE_TOKEN || process.env.THREESCRIBE_API_KEY || loadProfile().token || loadProfile().apiKey;
}
