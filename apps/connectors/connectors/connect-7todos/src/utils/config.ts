...
export function getApiKey(): string | undefined {
  return process.env.SEVENTODOS_API_KEY || loadProfile().apiKey;
}
...
export function getApiSecret(): string | undefined {
  return process.env.SEVENTODOS_API_SECRET || loadProfile().apiSecret;
}
...
export function getToken(): string | undefined {
  return process.env.SEVENTODOS_TOKEN || process.env.SEVENTODOS_API_KEY || loadProfile().token || loadProfile().apiKey;
}
