...
export function getApiKey(): string | undefined {
  return process.env.ZERO_BOUNCE_API_KEY || loadProfile().apiKey;
}
...
export function getApiSecret(): string | undefined {
  return process.env.ZERO_BOUNCE_API_SECRET || loadProfile().apiSecret;
}
...
export function getToken(): string | undefined {
  return process.env.ZERO_BOUNCE_API_KEY || process.env.ZERO_BOUNCE_TOKEN || loadProfile().token || loadProfile().apiKey;
}
