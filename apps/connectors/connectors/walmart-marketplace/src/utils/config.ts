...
export function getAccessToken(): string | undefined {
  return process.env.WALMART_ACCESS_TOKEN || loadProfile().accessToken;
}
...
export function getServiceName(): string | undefined {
  return process.env.WALMART_SERVICE_NAME || loadProfile().serviceName;
}
...
export function getBaseUrl(): string | undefined {
  return process.env.WALMART_BASE_URL || loadProfile().baseUrl;
}
...
export function getCorrelationId(): string | undefined {
  return process.env.WALMART_CORRELATION_ID || loadProfile().correlationId;
}
