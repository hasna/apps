...
// ============================================
// Superset Credentials Management
// ============================================
...
export function getBaseUrl(): string | undefined {
  const raw = process.env.SUPERSET_BASE_URL || loadProfile().baseUrl;
...
export function getUsername(): string | undefined {
  return process.env.SUPERSET_USERNAME || loadProfile().username;
}
...
export function getPassword(): string | undefined {
  return process.env.SUPERSET_PASSWORD || loadProfile().password;
}
...
export function getProvider(): AuthProvider {
  return (process.env.SUPERSET_PROVIDER as AuthProvider) || loadProfile().provider || 'db';
}
...
export function getAccessToken(): string | undefined {
  return process.env.SUPERSET_ACCESS_TOKEN || loadProfile().accessToken;
}
...
export function getRefreshToken(): string | undefined {
  return process.env.SUPERSET_REFRESH_TOKEN || loadProfile().refreshToken;
}
...
/**
 * Persist tokens returned by a login/refresh call.
 */
