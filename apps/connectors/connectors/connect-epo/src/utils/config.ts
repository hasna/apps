...
export function getConsumerKey(): string | undefined {
  return process.env.EPO_CONSUMER_KEY || loadProfile().consumerKey;
}

export function getConsumerSecret(): string | undefined {
  return process.env.EPO_CONSUMER_SECRET || loadProfile().consumerSecret;
}

export function setCredentials(consumerKey: string, consumerSecret: string): void {
...
export function getBaseUrl(): string | undefined {
  return process.env.EPO_BASE_URL || loadProfile().baseUrl;
}
