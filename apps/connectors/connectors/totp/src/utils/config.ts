...
export function getApiKey(): string | undefined {
  return process.env.TOTP_API_KEY || loadProfile().apiKey;
}

export function getBaseUrl(): string | undefined {
  return process.env.TOTP_BASE_URL || loadProfile().baseUrl;
}
...
export function getToken(): string | undefined {
  return process.env.TOTP_API_KEY || loadProfile().token || loadProfile().apiKey;
}
