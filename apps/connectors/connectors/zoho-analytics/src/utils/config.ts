...
const CONNECTOR_NAME = 'zoho-analytics';
const ENV_PREFIX = 'ZOHO_ANALYTICS';
...
// ============================================
// Token / org configuration
// ============================================

export function getToken(): string | undefined {
  return (
    process.env[`${ENV_PREFIX}_TOKEN`] ||
...
export function getOrgId(): string | undefined {
  return process.env[`${ENV_PREFIX}_ORG_ID`] || loadProfile().orgId;
}
...
export function getDataCenter(): string | undefined {
  return process.env[`${ENV_PREFIX}_DATA_CENTER`] || loadProfile().dataCenter;
}
