...
export function formatCredentialStatus(value: string | undefined): string {
...
export function getApiKey(): string | undefined {
  return (
    process.env.THE_TRADE_DESK_API_KEY ||
    process.env.THE_TRADE_DESK_TOKEN ||
    loadProfile().apiKey ||
    loadProfile().token
  );
}
...
export function getBaseUrl(): string | undefined {
  return (
    process.env.THE_TRADE_DESK_BASE_URL ||
    loadProfile().baseUrl ||
    DEFAULT_BASE_URL
  );
}
