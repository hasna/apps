...
// Sponge connector name
const CONNECTOR_NAME = 'sponge';
const DEFAULT_PROFILE = 'default';

export interface ProfileConfig {
  apiKey?: string;
  baseUrl?: string;    // Override default API base URL
  apiVersion?: string; // Sponge-Version header value
}
...
export function getApiKey(): string | undefined {
  return process.env.SPONGE_API_KEY || loadProfile().apiKey;
}
...
export function getBaseUrl(): string | undefined {
  return process.env.SPONGE_BASE_URL || loadProfile().baseUrl;
}
...
export function getApiVersion(): string | undefined {
  return process.env.SPONGE_VERSION || loadProfile().apiVersion;
}
