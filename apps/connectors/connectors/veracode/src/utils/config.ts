...
export function getApiKey(): string | undefined {
  return process.env.VERACODE_API_KEY || process.env.CONNECTOR_API_KEY || loadProfile().apiKey || loadProfile().token;
}

export function getBaseUrl(): string | undefined {
  return process.env.VERACODE_BASE_URL || process.env.CONNECTOR_BASE_URL || loadProfile().baseUrl;
}
...
export function getToken(): string | undefined {
  return process.env.VERACODE_API_KEY || process.env.CONNECTOR_TOKEN || process.env.CONNECTOR_API_KEY || loadProfile().token || loadProfile().apiKey;
}
