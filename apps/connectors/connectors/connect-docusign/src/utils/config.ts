...
export function getAccessToken(): string | undefined {
  return process.env.DOCUSIGN_ACCESS_TOKEN || loadProfile().accessToken;
}
...
export function getAccountId(): string | undefined {
  return process.env.DOCUSIGN_ACCOUNT_ID || loadProfile().accountId;
}
...
export function getBaseUrl(): string | undefined {
  return process.env.DOCUSIGN_BASE_URL || loadProfile().baseUrl;
}
