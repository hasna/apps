...
export const DEFAULT_BASE_URL = 'https://api.twelvedata.com';
...
export class ConnectorClient {
  ...
  buildUrl(path: string, params?: Record<string, string | number | boolean | undefined>): string {
    ...
    // Twelve Data uses apikey as a query parameter
  ...
  /**
   * Make an authenticated GET request to the Twelve Data API.
   * Authentication is via apikey query parameter.
   */
