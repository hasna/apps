...
export function getAccessToken(): string | undefined {
  return process.env.SALESFORCE_ACCESS_TOKEN || loadProfile().accessToken;
}
...
export function getInstanceUrl(): string | undefined {
  return process.env.SALESFORCE_INSTANCE_URL || loadProfile().instanceUrl;
}
