...
connect-bugherd is a TypeScript API connector CLI. It provides multi-profile configuration, Bearer token authentication (customizable), OAuth2 support, and a clean CLI structure using Commander.js.
