...
export function getApiKey(): string | undefined {
  return process.env.WOODPECKER_API_KEY || process.env.CONNECTOR_API_KEY || loadProfile().apiKey;
}
...
export function getToken(): string | undefined {
  return process.env.WOODPECKER_API_KEY || process.env.CONNECTOR_TOKEN || process.env.CONNECTOR_API_KEY || loadProfile().token || loadProfile().apiKey;
}
