...
export function getApiKey(): string | undefined {
  return process.env.UNLEASH_API_KEY || loadProfile().apiKey;
}

export function getBaseUrl(): string | undefined {
  return process.env.UNLEASH_BASE_URL || loadProfile().baseUrl;
}
...
export function getProjectId(): string {
  return process.env.UNLEASH_PROJECT || loadProfile().projectId || 'default';
}
...
export function getToken(): string | undefined {
  return process.env.UNLEASH_API_KEY || loadProfile().token || loadProfile().apiKey;
}
