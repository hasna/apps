...
export function getStoreId(): string | undefined {
  return process.env.YOTPO_STORE_ID || loadProfile().storeId;
}
...
export function getApiSecret(): string | undefined {
  return process.env.YOTPO_API_SECRET || loadProfile().apiSecret;
}
...
export function getBaseUrl(): string | undefined {
  return process.env.YOTPO_BASE_URL || loadProfile().baseUrl;
}
