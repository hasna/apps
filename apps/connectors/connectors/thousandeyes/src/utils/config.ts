...
export function ensureConfigDir(): void {
  ...
  securePath(CONFIG_DIR, 0o700);
  securePath(PROFILES_DIR, 0o700);
}
...
export function setCurrentProfile(profile: string): void {
  ...
  securePath(CURRENT_PROFILE_FILE, 0o600);
}
...
export function getApiKey(): string | undefined {
  return process.env.THOUSANDEYES_API_KEY || loadProfile().apiKey;
}
...
export function getBaseUrl(): string | undefined {
  return process.env.THOUSANDEYES_BASE_URL || loadProfile().baseUrl;
}
