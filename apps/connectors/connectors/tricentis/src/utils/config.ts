...
export function getApiKey(): string | undefined {
  return process.env.TRICENTIS_API_KEY || process.env.CONNECTOR_API_KEY || loadProfile().apiKey || loadProfile().token;
}

export function getBaseUrl(): string | undefined {
  return process.env.TRICENTIS_BASE_URL || process.env.CONNECTOR_BASE_URL || loadProfile().baseUrl;
}
