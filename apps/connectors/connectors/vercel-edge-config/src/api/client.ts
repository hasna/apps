import type { VercelEdgeConfigConfig } from '../types';
import { VercelEdgeConfigApiError } from '../types';

export const DEFAULT_BASE_URL = 'https://api.vercel.com';
...
export class VercelEdgeConfigClient {
  ...
  async request<T>(path: string, options: RequestOptions = {}): Promise<T> {
    ...
    if (!response.ok) {
      ...
      throw new VercelEdgeConfigApiError(message, response.status, code);
    }
