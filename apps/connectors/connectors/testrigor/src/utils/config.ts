...
const CONNECTOR_NAME = 'testrigor';
...
export function getApiKey(): string | undefined {
  return process.env.TESTRIGOR_API_KEY || process.env.CONNECTOR_API_KEY || loadProfile().apiKey;
}

export function getBaseUrl(): string | undefined {
  return process.env.TESTRIGOR_BASE_URL || process.env.CONNECTOR_BASE_URL || loadProfile().baseUrl;
}
