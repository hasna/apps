...
// ============================================
// StableBrowse Credentials Management
// ============================================

export function getApiKey(): string | undefined {
  return process.env.STABLEBROWSE_API_KEY || loadProfile().apiKey;
}
...
export function getBaseUrl(): string {
  return process.env.STABLEBROWSE_BASE_URL || loadProfile().baseUrl || DEFAULT_BASE_URL;
}
