...
export function getApiKey(): string | undefined {
  return process.env.ACCELO_ACCESS_TOKEN || loadProfile().apiKey;
}
...
export function getApiSecret(): string | undefined {
  return process.env.ACCELO_CLIENT_SECRET || loadProfile().apiSecret;
}
...
export function getToken(): string | undefined {
  return process.env.ACCELO_TOKEN || process.env.ACCELO_ACCESS_TOKEN || loadProfile().token || loadProfile().apiKey;
}
