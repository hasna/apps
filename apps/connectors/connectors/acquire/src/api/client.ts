...
// Acquire.io uses account-specific base URLs: https://{account_id}.acquire.io/api/v1
const DEFAULT_BASE_URL = 'https://app.acquire.io/api/v1';
...
export class ConnectorClient {
  ...
  constructor(config: ConnectorConfig) {
    ...
    if (config.baseUrl) {
      ...
      this.baseUrl = `https://${config.accountId}.acquire.io/api/v1`;
    } else {
  ...
  async request<T>(path: string, options: RequestOptions = {}): Promise<T> {
    ...
    // Acquire.io uses Bearer token authentication
