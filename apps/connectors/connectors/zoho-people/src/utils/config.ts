...
export function getApiKey(): string | undefined {
  return process.env.ZOHOPEOPLE_TOKEN || process.env.CONNECTOR_API_KEY || loadProfile().apiKey;
}
...
export function getToken(): string | undefined {
  return process.env.ZOHOPEOPLE_TOKEN || process.env.CONNECTOR_TOKEN || process.env.CONNECTOR_API_KEY || loadProfile().token || loadProfile().apiKey;
}

export function getDataCenter(): string {
  return process.env.ZOHOPEOPLE_DATA_CENTER || loadProfile().dataCenter || 'com';
}
