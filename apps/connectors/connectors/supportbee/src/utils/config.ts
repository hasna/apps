...
export interface ProfileConfig {
  // SupportBee token authentication
  apiKey?: string;
  token?: string;       // Alias for apiKey
  baseUrl?: string;     // Company-specific SupportBee URL
}
...
export function getApiKey(): string | undefined {
  return process.env.SUPPORTBEE_API_KEY || loadProfile().apiKey;
}
...
export function getToken(): string | undefined {
  return process.env.SUPPORTBEE_TOKEN || process.env.SUPPORTBEE_API_KEY || loadProfile().token || loadProfile().apiKey;
}
