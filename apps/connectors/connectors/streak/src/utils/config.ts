...
export function getApiKey(): string | undefined {
  return process.env.STREAK_API_KEY || loadProfile().apiKey;
}
...
export function getApiSecret(): string | undefined {
  return process.env.STREAK_API_SECRET || loadProfile().apiSecret;
}
...
export function getToken(): string | undefined {
  return process.env.STREAK_TOKEN || process.env.STREAK_API_KEY || loadProfile().token || loadProfile().apiKey;
}
