...
const DEFAULT_BASE_URL = 'https://api.terminusapp.com';
...
export class ConnectorClient {
  ...
  constructor(config: ConnectorConfig) {
    ...
    this.apiKey = key;
    this.baseUrl = (config.baseUrl || process.env.TERMINUS_BASE_URL || DEFAULT_BASE_URL).replace(/\/$/, '');
    const envMode = process.env.TERMINUS_AUTH_MODE;
    this.authMode =
      config.authMode ||
      (envMode === 'bearer' ? 'bearer' : envMode === 'basic' ? 'basic' : 'basic');
  }
