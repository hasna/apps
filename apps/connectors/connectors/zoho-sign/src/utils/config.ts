...
const CONNECTOR_NAME = 'connect-zoho-sign';
...
export function getToken(): string | undefined {
  return process.env.ZOHO_SIGN_TOKEN || loadProfile(getCurrentProfile()).token;
}
...
export function getDataCenter(): string | undefined {
  return process.env.ZOHO_SIGN_DATA_CENTER || loadProfile(getCurrentProfile()).dataCenter;
}
...
export function getBaseUrl(): string | undefined {
  return process.env.ZOHO_SIGN_BASE_URL || loadProfile(getCurrentProfile()).baseUrl;
}
