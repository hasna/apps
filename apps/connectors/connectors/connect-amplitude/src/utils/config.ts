...
const CONNECTOR_NAME = 'connect-amplitude';
...
export function getApiKey(): string | undefined {
  return process.env.AMPLITUDE_API_KEY || loadProfile().apiKey;
}
...
export function getSecretKey(): string | undefined {
  return process.env.AMPLITUDE_SECRET_KEY || loadProfile().secretKey;
}
