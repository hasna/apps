...
// Connector name (matches the registry slug)
const CONNECTOR_NAME = 'stripe-reporting-advanced';
...
export function getBaseUrl(): string | undefined {
  return process.env.STRIPE_BASE_URL || loadProfile().baseUrl;
}

export function getApiVersion(): string | undefined {
  return process.env.STRIPE_API_VERSION || loadProfile().apiVersion;
}
