...
export function getBaseUrl(): string | undefined {
  return process.env.SUGARCRM_BASE_URL || loadProfile().baseUrl;
}
...
export function getClientId(): string | undefined {
  return process.env.SUGARCRM_CLIENT_ID || loadProfile().clientId;
}
...
export function getClientSecret(): string | undefined {
  return process.env.SUGARCRM_CLIENT_SECRET || loadProfile().clientSecret;
}
...
export function getAccessToken(): string | undefined {
  return loadProfile().accessToken || getOAuthToken();
}
