...
export function getToken(): string | undefined {
  return process.env.WABOXAPP_TOKEN || loadProfile().token;
}
...
export function getUid(): string | undefined {
  return process.env.WABOXAPP_UID || loadProfile().uid;
}
...
export function getBaseUrl(): string | undefined {
  return process.env.WABOXAPP_BASE_URL || loadProfile().baseUrl;
}
