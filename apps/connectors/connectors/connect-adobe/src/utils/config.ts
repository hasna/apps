...
export function getApiKey(): string | undefined {
  return process.env.ADOBE_CLIENT_ID || loadProfile().apiKey;
}
...
export function getApiSecret(): string | undefined {
  return process.env.ADOBE_CLIENT_SECRET || loadProfile().apiSecret;
}
...
export function getToken(): string | undefined {
  return process.env.ADOBE_TOKEN || process.env.ADOBE_CLIENT_ID || loadProfile().token || loadProfile().apiKey;
}
