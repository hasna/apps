...
export function getClientId(): string | undefined {
  return process.env.TUMBLR_CLIENT_ID || loadProfile().clientId;
}
...
export function getClientSecret(): string | undefined {
  return process.env.TUMBLR_CLIENT_SECRET || loadProfile().clientSecret;
}
...
export function getAccessToken(): string | undefined {
  return process.env.TUMBLR_ACCESS_TOKEN || loadProfile().accessToken;
}
...
export function getRefreshToken(): string | undefined {
  return process.env.TUMBLR_REFRESH_TOKEN || loadProfile().refreshToken;
}
