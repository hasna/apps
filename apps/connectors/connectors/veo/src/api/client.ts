import type { VeoConfig } from '../types';
import { VeoApiError } from '../types';

export const DEFAULT_BASE_URL = 'https://api.veo.co.uk/api';
...
export class VeoClient {
  ...
  async request<T>(path: string, options: RequestOptions = {}): Promise<T> {
    ...
    if (!response.ok) {
      ...
      throw new VeoApiError(errorMessage, response.status);
    }
