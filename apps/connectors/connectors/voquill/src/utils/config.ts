...
export function getApiKey(): string | undefined {
  return process.env.VOQUILL_API_KEY || loadProfile().apiKey;
}

export function getBaseUrl(): string | undefined {
  return process.env.VOQUILL_BASE_URL || loadProfile().baseUrl;
}
...
export function getApiSecret(): string | undefined {
  return process.env.VOQUILL_API_SECRET || loadProfile().apiSecret;
}
...
export function getToken(): string | undefined {
  return process.env.VOQUILL_TOKEN || process.env.VOQUILL_API_KEY || loadProfile().token || loadProfile().apiKey;
}
