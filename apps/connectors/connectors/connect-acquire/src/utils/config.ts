...
export function getApiKey(): string | undefined {
  return process.env.ACQUIRE_API_KEY || loadProfile().apiKey;
}
...
export function getApiSecret(): string | undefined {
  return process.env.ACQUIRE_API_SECRET || loadProfile().apiSecret;
}
...
export function getToken(): string | undefined {
  return process.env.ACQUIRE_TOKEN || process.env.ACQUIRE_API_KEY || loadProfile().token || loadProfile().apiKey;
}
