...
// Config directory: ~/.hasna/connectors/connect-smartrecruiters/
...
export function getApiKey(): string | undefined {
  return process.env.SMARTRECRUITERS_API_KEY || loadProfile().apiKey;
}
...
export function getCompanyId(): string | undefined {
  return process.env.SMARTRECRUITERS_COMPANY_ID || loadProfile().companyId;
}
