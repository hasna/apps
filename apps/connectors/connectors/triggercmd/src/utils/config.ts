...
export function getApiKey(): string | undefined {
  return process.env.TRIGGERCMD_API_KEY || process.env.TRIGGERCMD_TOKEN || loadProfile().apiKey;
}
...
export function getApiSecret(): string | undefined {
  return process.env.TRIGGERCMD_API_SECRET || loadProfile().apiSecret;
}
...
export function getToken(): string | undefined {
  return process.env.TRIGGERCMD_TOKEN || process.env.TRIGGERCMD_API_KEY || loadProfile().token || loadProfile().apiKey;
}
