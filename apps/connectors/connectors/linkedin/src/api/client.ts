import type { LinkedInConfig, OutputFormat } from '../types';
import { LinkedInApiError } from '../types';

const DEFAULT_BASE_URL = 'https://api.linkedin.com/v2';
...
export class LinkedInClient {
  ...
  async request<T>(path: string, options: RequestOptions = {}): Promise<T> {
    ...
    // Handle errors
    if (!response.ok) {
      const errorData = data as { message?: string; status?: number; serviceErrorCode?: number; code?: string };
