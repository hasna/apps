...
const CONNECTOR_NAME = 'stripe-issuing';
...
export function getApiKey(): string | undefined {
  return process.env.STRIPE_ISSUING_API_KEY || loadProfile().apiKey;
}
...
export function getAccountId(): string | undefined {
  return process.env.STRIPE_ISSUING_ACCOUNT_ID || loadProfile().accountId;
}
...
export function getApiVersion(): string | undefined {
  return process.env.STRIPE_ISSUING_API_VERSION || loadProfile().apiVersion;
}
