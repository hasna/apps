...
const CONNECTOR_NAME = 'stripe-terminal';
...
export function getApiKey(): string | undefined {
  return process.env.STRIPE_TERMINAL_API_KEY || loadProfile().apiKey;
}
...
export function getAccountId(): string | undefined {
  return process.env.STRIPE_TERMINAL_ACCOUNT_ID || loadProfile().accountId;
}
...
export function getApiVersion(): string | undefined {
  return process.env.STRIPE_TERMINAL_API_VERSION || loadProfile().apiVersion;
}
