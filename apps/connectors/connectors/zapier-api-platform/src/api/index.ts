...
/**
 * Zapier API Platform connector.
 * Provides items, events, search, and raw HTTP request access.
 */
export class Connector {
  ...
  static fromEnv(): Connector {
    const apiKey = process.env.ZAPIER_API_PLATFORM_API_KEY;
    if (!apiKey) {
      throw new Error('ZAPIER_API_PLATFORM_API_KEY environment variable is required');
    }
