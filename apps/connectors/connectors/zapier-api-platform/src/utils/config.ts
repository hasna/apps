...
// TODO: Replace 'connector' with your connector name (e.g., 'connect-perplexity')
...
export function getApiKey(): string | undefined {
  return process.env.ZAPIER_API_PLATFORM_API_KEY || loadProfile().apiKey;
}
...
export function getApiSecret(): string | undefined {
  return process.env.ZAPIER_API_PLATFORM_API_SECRET || loadProfile().apiSecret;
}
...
export function getToken(): string | undefined {
  return process.env.ZAPIER_API_PLATFORM_TOKEN || process.env.ZAPIER_API_PLATFORM_API_KEY || loadProfile().token || loadProfile().apiKey;
}
