...
export function getApiKey(): string | undefined {
  return process.env.HUBSPOT_ACCESS_TOKEN || process.env.HUBSPOT_API_KEY || loadProfile().apiKey;
}
...
export function getBaseUrl(): string | undefined {
  return process.env.HUBSPOT_BASE_URL;
}

export function setBaseUrl(_baseUrl: string): void {
  // Base URL is only set via environment variable
}
