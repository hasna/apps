...
export function getApiKey(): string | undefined {
  return process.env.WINDMILL_API_KEY || loadProfile().apiKey;
}

export function getBaseUrl(): string | undefined {
  return process.env.WINDMILL_BASE_URL || loadProfile().baseUrl;
}

export function getWorkspace(): string | undefined {
  return process.env.WINDMILL_WORKSPACE || loadProfile().workspace;
}
