...
export function getApiKey(): string | undefined {
  return process.env.TRACKJS_API_KEY || loadProfile().apiKey;
}

export function getCustomerId(): string | undefined {
  return process.env.TRACKJS_CUSTOMER_ID || loadProfile().customerId;
}
...
export function getApiSecret(): string | undefined {
  return process.env.TRACKJS_API_SECRET || loadProfile().apiSecret;
}
...
export function getToken(): string | undefined {
  return process.env.TRACKJS_TOKEN || process.env.TRACKJS_API_KEY || loadProfile().token || loadProfile().apiKey;
}
