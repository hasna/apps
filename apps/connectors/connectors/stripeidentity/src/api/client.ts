...
// Stripe API base URL (Stripe Identity lives under the core Stripe API)
 ...
 * Stripe uses bracket notation: metadata[key]=value, options[document][allowed_types][0]=passport
 */
