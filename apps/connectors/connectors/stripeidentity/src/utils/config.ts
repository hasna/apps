...
// Stripe Identity connector name
const CONNECTOR_NAME = 'stripeidentity';
...
export function getApiKey(): string | undefined {
  return process.env.STRIPE_IDENTITY_API_KEY || loadProfile().apiKey;
}
...
export function getAccountId(): string | undefined {
  return process.env.STRIPE_IDENTITY_ACCOUNT_ID || loadProfile().accountId;
}
