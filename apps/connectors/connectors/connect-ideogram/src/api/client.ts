...
import { IdeogramApiError } from '../types';
...
export class IdeogramClient {
  ...
  async generate(params: GenerateRequest): Promise<GenerateResponse> {
    return this.post<GenerateResponse>('/generate', { image_request: params });
  }

  async describe(params: DescribeRequest): Promise<DescribeResponse> {
    return this.post<DescribeResponse>('/describe', params);
  }

  async remix(params: RemixRequest): Promise<GenerateResponse> {
    return this.post<GenerateResponse>('/remix', { image_request: params });
  }

  async upscale(params: UpscaleRequest): Promise<UpscaleResponse> {
    return this.post<UpscaleResponse>('/upscale', { image_request: params });
  }
