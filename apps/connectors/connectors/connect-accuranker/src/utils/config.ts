...
export function getApiKey(): string | undefined {
  return process.env.ACCURANKER_API_KEY || loadProfile().apiKey;
}
...
export function getApiSecret(): string | undefined {
  return process.env.ACCURANKER_API_SECRET || loadProfile().apiSecret;
}
...
export function getToken(): string | undefined {
  return process.env.ACCURANKER_TOKEN || process.env.ACCURANKER_API_KEY || loadProfile().token || loadProfile().apiKey;
}
