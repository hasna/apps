...
export function getToken(): string | undefined {
  return process.env.ZOHO_SURVEY_TOKEN || loadProfile().token || loadProfile().accessToken;
}
...
export function getPortalId(): string | undefined {
  return process.env.ZOHO_SURVEY_PORTAL_ID || loadProfile().portalId;
}
...
export function getDepartmentId(): string | undefined {
  return process.env.ZOHO_SURVEY_DEPARTMENT_ID || loadProfile().departmentId;
}

export function setDepartmentId(departmentId: string): void {
  const config = loadProfile();
...
export function getBaseUrl(): string | undefined {
  return process.env.ZOHO_SURVEY_BASE_URL || loadProfile().baseUrl;
}
...
// Legacy aliases used by scaffold utils
...
export function getApiSecret(): string | undefined {
  return loadProfile().clientSecret;
}

export function setApiSecret(apiSecret: string): void {
  const profile = loadProfile();
  profile.clientSecret = apiSecret;
  saveProfile(profile);
}
