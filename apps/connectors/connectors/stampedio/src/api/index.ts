...
export class Stampedio {
   ...
   * Reads STAMPEDIO_PUBLIC_KEY, STAMPEDIO_PRIVATE_KEY, STAMPEDIO_STORE_HASH,
  ...
  static fromEnv(): Stampedio {
    ...
    if (!publicKey) throw new Error('STAMPEDIO_PUBLIC_KEY environment variable is required');
