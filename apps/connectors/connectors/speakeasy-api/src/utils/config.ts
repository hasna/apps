...
export function getApiKey(): string | undefined {
  return process.env.SPEAKEASY_API_KEY || process.env.SPEAKEASY_TOKEN || loadProfile().apiKey || loadProfile().token;
}
...
export function getBaseUrl(): string | undefined {
  return process.env.SPEAKEASY_BASE_URL || loadProfile().baseUrl;
}

export function getWorkspaceId(): string | undefined {
  return process.env.SPEAKEASY_WORKSPACE_ID || loadProfile().workspaceId;
}
...
export function buildConnectorConfig(): { apiKey?: string; token?: string; baseUrl?: string; workspaceId?: string } {
