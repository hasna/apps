...
export function getApiKey(): string | undefined {
  return process.env.ACTION_NETWORK_API_KEY || loadProfile().apiKey;
}
...
export function getApiSecret(): string | undefined {
  return process.env.ACTION_NETWORK_API_SECRET || loadProfile().apiSecret;
}
...
export function getToken(): string | undefined {
  return process.env.ACTION_NETWORK_TOKEN || process.env.ACTION_NETWORK_API_KEY || loadProfile().token || loadProfile().apiKey;
}
