...
bun run dev run "Navigate to google.com and search for AI"
```
...
│   ├── tasks.ts      # Tasks API module
│   ├── sessions.ts   # Sessions API module
│   ├── profiles.ts   # Browser Profiles API module
│   ├── browsers.ts   # Browser Sessions API module
│   ├── skills.ts     # Skills & Marketplace API modules
│   ├── files.ts      # Files API module
│   ├── billing.ts    # Billing API module
│   └── index.ts      # Main BrowserUse connector class
├── cli/
...
Browser Use Cloud API: https://docs.browser-use.com/cloud/api
