...
export function getApiKey(): string | undefined {
  return process.env.AGILECRM_API_KEY || loadProfile().apiKey;
}
...
export function getApiSecret(): string | undefined {
  return process.env.AGILECRM_EMAIL || loadProfile().apiSecret;
}
...
export function getToken(): string | undefined {
  return process.env.AGILECRM_TOKEN || process.env.AGILECRM_API_KEY || loadProfile().token || loadProfile().apiKey;
}
