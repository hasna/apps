...
export function getToken(): string | undefined {
  return process.env.ZOHOCAMPAIGNS_TOKEN || loadProfile().token;
}
...
export function getDataCenter(): string | undefined {
  return process.env.ZOHOCAMPAIGNS_DATA_CENTER || loadProfile().dataCenter;
}
...
export function getBaseUrl(): string | undefined {
  return process.env.ZOHOCAMPAIGNS_BASE_URL || loadProfile().baseUrl;
}
