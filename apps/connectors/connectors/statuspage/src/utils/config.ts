...
export function getApiKey(): string | undefined {
  return process.env.STATUSPAGE_API_KEY || loadProfile().apiKey;
}
...
export function getPageId(): string | undefined {
  return process.env.STATUSPAGE_PAGE_ID || loadProfile().pageId;
}

export function setPageId(pageId: string): void {
  const config = loadProfile();
