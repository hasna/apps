...
import type { SparkPostRegion } from '../types';
...
export function getApiKey(): string | undefined {
  return process.env.SPARKPOST_API_KEY || loadProfile().apiKey;
}

export function getRegion(): SparkPostRegion {
  const envRegion = process.env.SPARKPOST_REGION;
...
export function setRegion(region: SparkPostRegion): void {
  const config = loadProfile();
