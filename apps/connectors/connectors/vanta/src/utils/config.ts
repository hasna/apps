...
export function getClientId(): string | undefined {
  return process.env.VANTA_CLIENT_ID || loadProfile().clientId;
}

export function getClientSecret(): string | undefined {
  return process.env.VANTA_CLIENT_SECRET || loadProfile().clientSecret;
}

export function getScope(): string {
  return process.env.VANTA_SCOPE || loadProfile().scope || DEFAULT_SCOPE;
}

export function getBaseUrl(): string {
  return process.env.VANTA_BASE_URL || loadProfile().baseUrl || DEFAULT_BASE_URL;
}

export function setCredentials(
  clientId: string,
  clientSecret: string,
  options?: { scope?: string; baseUrl?: string },
): void {
