...
export function getApiKey(): string | undefined {
  return process.env.TRUSTPILOT_API_KEY || loadProfile().apiKey;
}
...
export function getAccessToken(): string | undefined {
  return process.env.TRUSTPILOT_ACCESS_TOKEN || loadProfile().accessToken;
}
...
export function getBaseUrl(): string | undefined {
  return process.env.TRUSTPILOT_BASE_URL;
}
