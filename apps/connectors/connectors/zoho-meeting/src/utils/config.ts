...
const CONNECTOR_NAME = 'zoho-meeting';
...
export function getToken(): string | undefined {
  return process.env.ZOHO_MEETING_TOKEN || loadProfile().token;
}
...
export function getDataCenter(): string {
  return process.env.ZOHO_MEETING_DATA_CENTER || loadProfile().dataCenter || 'com';
}
...
export function getBaseUrl(): string | undefined {
  return process.env.ZOHO_MEETING_BASE_URL || loadProfile().baseUrl;
}
