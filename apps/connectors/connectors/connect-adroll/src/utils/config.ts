...
export function getApiKey(): string | undefined {
  return process.env.ADROLL_API_KEY || process.env.ADROLL_TOKEN || loadProfile().apiKey;
}
...
export function getApiSecret(): string | undefined {
  return process.env.ADROLL_API_SECRET || loadProfile().apiSecret;
}
...
export function getToken(): string | undefined {
  return process.env.ADROLL_TOKEN || process.env.ADROLL_API_KEY || loadProfile().token || loadProfile().apiKey;
}
