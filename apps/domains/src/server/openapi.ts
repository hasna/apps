    ...
    components: {
      ...
      schemas: {
        ...
        DomainProvisioningJob: {
          ...
          required: ["id","domain_id","name","idempotency_key","request_hash","status","max_price_usd","years","auto_renew","acquisition_mode","registrar","dns_provider","target","worker_name","origin_hostname","provider_state","result","attempts","created_at","updated_at"],
        },
        ...
        DomainProvisioningResult: {
          ...
          required: ["zone_ref", "nameservers", "web_records", "checked_at"],
        },
        HostedDnsRecord: {
          type: "object",
          additionalProperties: false,
