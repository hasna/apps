...
export interface DomainProvisioningRequest { "name": string; "max_price_usd": number; "years": number; "auto_renew": boolean; "registrar"?: "route53"; "dns_provider"?: "cloudflare"; "target"?: "shortlinks" | "website_origin"; "worker_name"?: string | null; "origin_hostname"?: string | null; "origin_tls_mode"?: "strict" | "full" | null }

export interface DomainAdoptionRequest { "name": string; "dns_provider"?: "cloudflare"; "target": "shortlinks" | "website_origin"; "worker_name"?: string | null; "origin_hostname"?: string | null; "origin_tls_mode"?: "strict" | "full" | null }

export interface DomainProvisioningProviderState { "quoted_price_usd"?: number; "currency"?: string; "registration_operation_id"?: string; "nameserver_operation_id"?: string; "cloudflare_zone_id"?: string; "cloudflare_nameservers"?: Array<string>; "route53_zone_ids_before_registration"?: Array<string>; "route53_hosted_zone_id"?: string; "route53_hosted_zone_cleaned"?: boolean; "worker_domain_bound"?: boolean; "website_origin_configured"?: boolean; "origin_tls_mode_configured"?: "strict" | "full" | "origin_pull"; "origin_tls_mode_checked_at"?: string; "web_records"?: Array<ProvisionedWebRecord>; "target_checked_at"?: string; "last_provider_status"?: string; "registration_submitted_at"?: string; "nameservers_submitted_at"?: string; "delegation_dns_preserved_count"?: number; "delegation_dns_preserved_sha256"?: string; "delegation_dns_preserved_at"?: string }

export interface DomainProvisioningJob { "id": string; "domain_id": string; "name": string; "idempotency_key": string; "request_hash": string; "status": "requested" | "quoted" | "registration_submitting" | "registration_submitted" | "registered" | "zone_ready" | "nameservers_submitted" | "delegated" | "worker_bound" | "ready" | "manual_review" | "failed"; "max_price_usd": number; "years": number; "auto_renew": boolean; "acquisition_mode": "purchase" | "adopt"; "registrar": "route53" | "brandsight"; "dns_provider": string; "target": string; "worker_name": string | null; "origin_hostname": string | null; "origin_tls_mode": "strict" | "full" | null; "provider_state": DomainProvisioningProviderState; "result": DomainProvisioningResult | null; "attempts": number; "error"?: string | null; "lease_until"?: string | null; "created_at": string; "updated_at": string }

export interface ProvisionedWebRecord { "type": "CNAME"; "name": string; "value": string; "proxied": true; "ttl": number }

export interface DomainProvisioningResult { "zone_ref": string; "nameservers": Array<string>; "web_records": Array<ProvisionedWebRecord>; "origin_tls_mode": "strict" | "full" | null; "checked_at": string }
