...
export interface DomainProvisioningJob { "id": string; "domain_id": string; "name": string; "idempotency_key": string; "request_hash": string; "status": "requested" | "quoted" | "registration_submitting" | "registration_submitted" | "registered" | "zone_ready" | "nameservers_submitted" | "delegated" | "worker_bound" | "ready" | "manual_review" | "failed"; "max_price_usd": number; "years": number; "auto_renew": boolean; "acquisition_mode": "purchase" | "adopt"; "registrar": string; "dns_provider": string; "target": string; "worker_name": string | null; "origin_hostname": string | null; "origin_tls_mode": "strict" | "full" | null; "provider_state": DomainProvisioningProviderState; "result": DomainProvisioningResult | null; "attempts": number; "error"?: string | null; "lease_until"?: string | null; "created_at": string; "updated_at": string }
