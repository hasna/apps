...
let attachmentsInstalled = true;
try {
  await import("@hasna/attachments");
} catch {
  attachmentsInstalled = false;
}

describe("shareDocument", () => {
  test.skipIf(attachmentsInstalled)("throws if attachments package not available", async () => {
...
describe("receiveDocument", () => {
  test.skipIf(attachmentsInstalled)("throws if attachments package not available or ID not found", async () => {
