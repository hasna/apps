...
- 18ec8fb: MCP server fails closed at startup: `calendar-mcp` refuses to start — exit 1 with
...
- 8d9e2dd: Resolve credentials and authority through the `@hasna/contracts` client chain (hasna/apps#1720).
