...
// README.md documents as "The app UI" and scripts/build_notes.sh bundles into
...
// OSS repo, so a shipped page must present itself as Hasna Notes and never carry
// another vendor's product name.

const HTML_FILE = /\.html$/;
const UI_DIR = 'web';
const PRODUCT_NAME = 'Hasna Notes';
