// Rasterize the Hasna Notes brand SVGs into the macOS AppIcon iconset + evidence
...
//
// Outputs (checked into the tree; scripts/build_notes.sh assembles the
...
const iconSVG = dataURL('notes-icon.svg')
...
for (const [svg, name] of [['notes-menubar.svg', 'menubar-idle'], ['notes-menubar-rec.svg', 'menubar-rec']]) {
