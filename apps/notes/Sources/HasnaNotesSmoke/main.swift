...
let tempRoot = FileManager.default.temporaryDirectory
    .appendingPathComponent("notes-smoke-\(UUID().uuidString)")
...
do {
    ...
    check(raw.contains("agent: notes-app"), "frontmatter has new agent default")
    ...
    do {
        let eventsRoot = FileManager.default.temporaryDirectory
            .appendingPathComponent("notes-events-smoke-\(UUID().uuidString)")
    ...
    do {
        let strictRoot = FileManager.default.temporaryDirectory
            .appendingPathComponent("notes-strict-events-smoke-\(UUID().uuidString)")
    ...
    do {
        let fallbackRoot = FileManager.default.temporaryDirectory
            .appendingPathComponent("notes-fallback-events-smoke-\(UUID().uuidString)")
    ...
    do {
        let collisionRoot = FileManager.default.temporaryDirectory
            .appendingPathComponent("notes-spool-collision-smoke-\(UUID().uuidString)")
        ...
        let linkRoot = FileManager.default.temporaryDirectory
            .appendingPathComponent("notes-spool-link-smoke-\(UUID().uuidString)")
