 ...
 * waiver for a service-capable member shipping trash-serve, measured
 ...
 *
 *   Point TRASH_TEST_DATABASE_URL at a throwaway test database:
 *   bun run test:postgres
 *
 * The connection string is never printed.
 */
const ENV_VAR = "TRASH_TEST_DATABASE_URL";
