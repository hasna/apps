...
//
// Two gates, both driven by @hasna/contracts PINNED to EXACTLY 0.14.2 (registry
// devDependency "0.14.0", no caret) so a concurrent publish of 0.14.2 cannot
// re-break this app:
...
const PINNED_CONTRACTS_VERSION = "0.14.2";
