...
// Publish-guard regression (row 27d2a7a2): the packed tarball of
// @hasna/consolidations must carry no internal-infra strings. Mirrors
...
// the fix (aws-account-id hits from bundled dep constants) and passes after.
const consolidations = "consolidations";
...
test(
  `@hasna/${consolidations} packed tarball carries no internal-infra strings`,
  () => {
