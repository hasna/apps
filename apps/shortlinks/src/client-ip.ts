...
//
// The fleet is reachable through the api.hasna.com Cloudflare-worker gateway,
// which forwards
...
export const TRUST_PROXY_ENV = "SHORTLINKS_TRUST_PROXY";
export const TRUSTED_PROXIES_ENV = "SHORTLINKS_TRUSTED_PROXIES";
