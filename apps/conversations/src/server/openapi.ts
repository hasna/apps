...
export const openapiSpec = {
  ...
  components: {
    ...
    schemas: {
      ...
      FullExportAuthorization: {
        type: "object",
        additionalProperties: false,
        required: ["principal", "reason", "acknowledged"],
        properties: {
      ...
      MessageExportRequest: {
        ...
        properties: {
          ...
          detail: { type: "string", enum: ["preview", "full"], default: "preview" },
          ...
          authorization: { $ref: "#/components/schemas/FullExportAuthorization" },
        },
      },
  ...
  paths: {
    ...
    "/v1/messages": {
      get: {
        ...
        parameters: [
          ...
          { name: "detail", in: "query", schema: { type: "string", enum: ["preview"] } },
          { name: "max_bytes", in: "query", schema: { type: "integer", minimum: 512, maximum: 65536 } },
          { name: "preview_bytes", in: "query", schema: { type: "integer", minimum: 1, maximum: 1024 } },
          { name: "timeout_ms", in: "query", schema: { type: "integer", minimum: 1, maximum: 5000 } },
        ],
    ...
    "/v1/messages/exports": {
      post: {
        ...
        summary: "Create a bounded message export artifact",
        description:
          "Creates a preview-only artifact by default. Full detail requires an explicit authorization object whose principal matches the authenticated API-key principal. The response contains metadata only; retrieve the bounded artifact separately.",
        requestBody: {
          required: false,
        ...
        responses: {
          ...
          "403": { description: "authorization principal mismatch" },
        },
      },
    },
    "/v1/messages/exports/{artifact_id}": {
      get: {
        ...
        summary: "Download one bounded export artifact owned by the authenticated principal",
        ...
        responses: {
          ...
          "404": { description: "missing or not owned by this principal" },
        },
      },
    },
    "/v1/channel-notifications/inbox": {
      get: {
        ...
        responses: {
          ...
          "403": { description: "agent does not match authenticated principal" },
        },
      },
    },
    "/v1/messages/bulk": {
