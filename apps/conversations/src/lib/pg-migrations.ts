...
export const PG_MIGRATIONS: string[] = [
  ...
  CREATE TRIGGER incident_projection_messages_no_mutation
    BEFORE UPDATE ON messages FOR EACH ROW EXECUTE FUNCTION reject_incident_projection_message_mutation();
  ...
  CREATE TRIGGER incident_projection_messages_no_delete
    BEFORE DELETE ON messages FOR EACH ROW EXECUTE FUNCTION reject_incident_projection_message_mutation();
