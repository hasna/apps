...
const PACKAGE_NAME = "@hasna/paths";

// `import.meta.url` points at this file in development and at the bundled entry point
// (`dist/index.js`, `dist/cli/index.js`) in the published package, so the manifest sits
// one, two, or three levels up depending on the caller.
...
export const PATHS_VERSION = readPackageVersion();
