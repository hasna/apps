export {
  ...
  type KnowledgeAppWikiInitOptions,
  type KnowledgeAppWikiNoteInput,
  type KnowledgeAppWikiQueryOptions,
  type KnowledgeAppWikiScopeOptions,
  type KnowledgeAppWikiSdk,
  type KnowledgeAppWikiSearchOptions,
  type KnowledgeAppWikiSourceInput,
...
export {
  ...
  type KnowledgeProjectAuthorityIdentity,
  type KnowledgeProjectCollectionRecord,
  type KnowledgeProjectInverseRequest,
  type KnowledgeProjectInverseVerification,
  type KnowledgeProjectItemBindingRecord,
  type KnowledgeProjectItemBindingRequest,
  type KnowledgeProjectLinksAuthority,
  type KnowledgeProjectLinksAuthorityOptions,
  type KnowledgeProjectLinksErrorCode,
  type KnowledgeProjectLinksHttpClientOptions,
  type KnowledgeProjectReceiptAction,
  type KnowledgeProjectReceiptLookupRequest,
  type KnowledgeProjectReceiptOutcome,
  ...
  type KnowledgeProjectResourcePage,
...
export {
  ...
  type CreateKnowledgePrivateInputDescriptorOptions,
  type CreateKnowledgePrivateQueryDescriptorOptions,
  type CreateKnowledgePrivateTitleLookupDescriptorOptions,
  type KnowledgeAuthorityBinding,
  type KnowledgeAuthorityClassification,
  type KnowledgeGuardedAdoptionAction,
  ...
  type KnowledgeGuardedReceiptStatus,
  type KnowledgeGuardedRecoveryKeyInput,
  type KnowledgeGuardedRecoveryStrategy,
  type KnowledgeGuardedRollbackResult,
  type KnowledgeGuardedSubmission,
  type KnowledgeGuardedTitleLookup,
  type KnowledgeGuardedUpdatePayload,
  ...
  type KnowledgePrivateQueryItemProof,
  type KnowledgePrivateQueryKind,
  type KnowledgePrivateQueryPage,
  ...
  type KnowledgeRelationsMetadata,
...
export {
  ...
  isKnowledgeLocalOptIn,
  knowledgeAuthorityEnvKeys,
  knowledgeFailClosedMessage,
  knowledgeKeychainTierOptions,
  resetKnowledgeLocalModeNotice,
  resolveKnowledgeClientTransport,
  selectsKnowledgeLocalStore,
...
export {
  ...
  KnowledgeService,
  type KnowledgeAppWikiInitResult,
  type KnowledgeAppWikiNote,
  type KnowledgeAppWikiNoteReadResult,
  type KnowledgeAppWikiNoteResult,
  type KnowledgeAppWikiNoteInput as KnowledgeServiceAppWikiNoteInput,
  type KnowledgeAppWikiSourceInput as KnowledgeServiceAppWikiSourceInput,
...
export {
  ...
  type KnowledgeMachinesAdapterMode,
  type KnowledgeMachinesAdapterStatus,
  type KnowledgeMachineCommandResult,
  type KnowledgeMachineCommandRunner,
  type KnowledgeMachineEntry,
  type KnowledgeMachinePreflightCheck,
  type KnowledgeMachinePreflightCommandResult,
  type KnowledgeMachinePreflightCommandSpec,
  type KnowledgeMachinePreflightOptions,
  type KnowledgeMachinePreflightPackageSpec,
  type KnowledgeMachinePreflightReport,
  type KnowledgeMachinePreflightRunner,
  type KnowledgeMachinePreflightSource,
