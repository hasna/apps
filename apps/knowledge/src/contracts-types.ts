...
// ── @hasna/contracts — the project-panel contract ──────────────────────────
...
export type ProjectPanelResourceKind =
  | "knowledge" | "render" | "app" | "email" | "feedback" | "report" | "run" | "unknown" | "file" | "url"
  | "model" | "workflow" | "budget" | "task" | "project" | "repo" | "loop" | "action" | "event" | "integration"
  | "session" | "machine" | "tool" | "document" | "artifact" | "conversation" | "dashboard" | "panel" | "commit"
  | "branch" | "pull_request" | "issue" | "comment" | "verification" | "finding" | "context_pack" | "proof_bundle"
  | "memento" | "eval" | "cost" | "alert" | "incident" | "release" | "rollout" | "announcement" | "audience";
...
export type ProjectPanelEvidenceKind =
  | "report" | "file" | "url" | "artifact" | "video" | "other" | "command_output" | "screenshot" | "log"
  | "diff" | "har" | "test_result" | "metric" | "trace";
