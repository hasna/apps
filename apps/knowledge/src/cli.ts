...
Global Options:
  ...
  --scope local|global|project  Store scope (default: global — legacy the knowledge data root, resolved through @hasna/paths to the XDG data home once adopted)
