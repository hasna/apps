import { type KnowledgePrivateEditApproval, type KnowledgePrivateEditReviewer, type KnowledgePrivateReviewDescriptor, type KnowledgePrivateReviewer, type KnowledgePrivateReviewProof } from './guarded-review.js';
...
export interface KnowledgeGuardedWriter {
    ...
    approvePrivateEdit(descriptor: KnowledgePrivateReviewDescriptor, approvedBy: string, reviewer: KnowledgePrivateEditReviewer, bounds?: KnowledgeGuardedBounds): Promise<KnowledgePrivateEditApproval>;
