 ...
 *
 * The storage kit resolves the server backend from HASNA_SECRETS_DATABASE_URL
 * (present -> PostgreSQL, absent -> SQLite), and the auth middleware wants the
 * signing secret. This module maps the injected names onto the canonical ones
 * exactly once.
 */
