...
import { registerOpTools, type DomainExecutor } from "./shared.js";

export function registerElevationTools(server: McpServer, ctx?: AuthorizationContext, execute?: DomainExecutor): void {
  registerOpTools(server, [
    ...
    { name: "list_elevations", op: "elevation.list", summary: "List elevations", write: false, schema: { identity_id: z.string().optional(), entity_id: z.string().optional(), status: z.enum(["pending", "active", "expired", "revoked"]).optional(), limit: z.number().optional() } },
