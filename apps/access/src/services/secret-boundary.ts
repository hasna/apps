...
const RAW_SECRET_PATTERNS = [
  ...
  /\b(?:sk[-][A-Za-z0-9_-]{8,}|xai[-][A-Za-z0-9_-]{8,}|npm[_][A-Za-z0-9_-]{8,}|ghp[_][A-Za-z0-9_]{8,}|gho[_][A-Za-z0-9_]{8,}|ghs[_][A-Za-z0-9_]{8,}|github[_]pat[_][A-Za-z0-9_]+|glpat[-][A-Za-z0-9_-]{8,}|AKIA[0-9A-Z]{12,}|ASIA[0-9A-Z]{12,})\b/,
