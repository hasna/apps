      ...
      async ({ tool_name }) => {
        try {
          ...
          const toolDocs: Record<string, string> = {
            ...
            list_projects: "list_projects — Compact paged projects by default. Params: status, limit, offset, cursor, full/all",
            ...
            list_task_lists: "list_task_lists — Compact paged task lists by default. Params: project_id, status, limit, offset, cursor, full/all",
            get_task_list: "get_task_list — Metadata + task_count by default; bounded nested tasks when requested. Params: task_list_id, include_tasks, tasks_limit, tasks_offset, tasks_cursor, full/all",
            ...
            list_plans: "list_plans — Compact paged plans by default. Params: project_id, status, limit, offset, cursor, full/all",
            get_plan: "get_plan — Metadata + task_count by default; bounded nested tasks when requested. Params: plan_id, include_tasks, tasks_limit, tasks_offset, tasks_cursor, full/all",
            ...
            list_agents: "list_agents — Compact paged agents by default. Params: include_archived, limit, offset, cursor, full/all",
