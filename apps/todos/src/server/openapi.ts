...
export function buildV1OpenApiDocument(version = getPackageVersion()) {
  return structuredClone({
    ...
    components: {
      ...
      schemas: {
        MachineAuthority: { type: "object", additionalProperties: false, required: ["tenant_id", "kid"], properties: { tenant_id: { type: "string", minLength: 1 }, kid: { type: "string", minLength: 1 } } },
    ...
    paths: {
      "/v1/machines": {
        get: { operationId: "listMachines", summary: "Read the complete shared machine registry", responses: {
          "200": { description: "Registry capability and complete machine records", content: { "application/json": { schema: { type: "object", required: ["authority", "schema_version", "machines"], properties: { authority: { $ref: "#/components/schemas/MachineAuthority" }, schema_version: { type: "integer", enum: [2] }, machines: { type: "array", items: { $ref: "#/components/schemas/Machine" } } } } } } },
        } },
        post: { operationId: "mutateMachineRegistry", summary: "Apply an atomic machine registry operation", requestBody: { required: true, content: { "application/json": { schema: { type: "object", required: ["action", "expected_authority"], properties: {
          expected_authority: { $ref: "#/components/schemas/MachineAuthority" }, action: { type: "string", enum: ["register", "heartbeat", "set-primary", "archive", "unarchive", "delete", "import"] }, name: { type: "string" }, id: { type: "string" }, options: { type: "object" }, machines: { type: "array", maxItems: 10000, items: { $ref: "#/components/schemas/Machine" } },
        } } } } }, responses: {
          "200": { description: "Committed registry receipt", content: { "application/json": { schema: { type: "object", required: ["authority", "schema_version", "machines", "inserted", "skipped"], properties: { authority: { $ref: "#/components/schemas/MachineAuthority" }, schema_version: { type: "integer", enum: [2] }, machines: { type: "array", items: { $ref: "#/components/schemas/Machine" } }, machine: { $ref: "#/components/schemas/Machine" }, inserted: { type: "integer" }, skipped: { type: "integer" }, deleted: { type: "boolean" } } } } } },
        } },
      },
              ...
              "application/json": {
                schema: {
                  ...
                  properties: {
                    ...
                    expected_machine_authority: { $ref: "#/components/schemas/MachineAuthority" },
                ...
                "application/json": {
                  schema: {
                    ...
                    properties: {
                      ...
                      machine_authority: { $ref: "#/components/schemas/MachineAuthority" },
                      result: {
                        type: "object",
                        properties: {
