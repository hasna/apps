...
(machines, dispatch, templates, handoffs, boards, runs, `todos://projects`, …)
answer `REMOTE_COMMAND_UNSUPPORTED` naming the opt-in, instead of reading an
empty local file and reporting it as the fleet.
