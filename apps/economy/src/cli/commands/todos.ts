...
export function printTodosHelp(): void {
  ...
  console.log()
  console.log(chalk.bold('  Multi-machine storage'))
  console.log('    local       on-box SQLite; economy sync ingests this machine\'s agent data')
  console.log('    cloud       CLI/MCP reads and writes the shared /v1 API directly with URL + key')
  console.log('    fleet       machine_id keeps shared summaries and per-machine filters distinct')
  console.log()
