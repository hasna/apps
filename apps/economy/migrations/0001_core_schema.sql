-- @generated mirror of PG_MIGRATIONS (src/db/pg-migrations.ts) + @hasna/contracts api_keys.
-- Source of truth / runner:  economy-serve migrate  (uses applyPgMigrations + ApiKeyStore.ensureSchema)
...
-- ── @hasna/contracts API keys ──
-- api_keys migration: hasna_auth_0001_api_keys
...
-- api_keys migration: hasna_auth_0002_api_keys_indexes
