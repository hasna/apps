...
Economy can run as an on-machine SQLite application or as a client of a shared hosted HTTP service. These guides describe the current command and network surfaces:
...
- [Configuration](configuration.md) — data paths, environment variables, the local and hosted client backends, and authentication.
