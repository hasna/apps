...
chunks=(
  ...
  "src/lib/qol.test.ts src/lib/recorder.test.ts src/lib/session-v3.test.ts src/lib/network.test.ts src/lib/semantic-actions.test.ts src/lib/video-presets.test.ts src/lib/video-recording.test.ts"
