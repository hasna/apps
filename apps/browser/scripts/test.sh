...
chunks=(
  ...
  "src/lib/agents.test.ts src/lib/downloads.test.ts src/lib/integrations.test.ts src/lib/snapshot-diff.test.ts src/lib/stealth.test.ts src/lib/extension-bridge.test.ts extension/src/executor.test.ts"
)
