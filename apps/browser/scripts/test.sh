...
chunks=(
  ...
  "src/lib/qol.test.ts src/lib/recorder.test.ts src/lib/session-v3.test.ts src/lib/network.test.ts src/lib/semantic-actions.test.ts src/lib/video-presets.test.ts src/lib/video-recording.test.ts src/lib/workflow-manifests.test.ts"
  "src/lib/agents.test.ts src/lib/downloads.test.ts src/lib/integrations.test.ts src/lib/snapshot-diff.test.ts src/lib/stealth.test.ts src/lib/policy.test.ts src/lib/session-policy.test.ts src/lib/extension-bridge.test.ts extension/src/executor.test.ts"
)
