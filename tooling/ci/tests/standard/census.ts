...
export const MCP_EXCEPTIONS: Array<{ member: string; reason: string }> = [
  ...
  { member: "estate-sync", reason: "Library-shaped sync engine (estate-store push/pull, O15-00627); ships estate-sync CLI + ./sdk only, no MCP surface." },
...
export const SERVE_EXCEPTIONS: Array<{ member: string; reason: string }> = [
  ...
  { member: "estate-sync", reason: "Library-shaped sync engine (estate-store push/pull, O15-00627); no server surface." },
