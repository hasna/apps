 ...
 * measured without one (24 — 23 at the original census, connectors added
 * by the integrator lane for imports #80, hooks removed when #102 added its
 * manifest on 2026-08-14) — each recorded with the
