...
export const SERVE_EXCEPTIONS: Array<{ member: string; reason: string }> = [
  ...
  { member: "otp", reason: "CLI/MCP-shaped member (otp CLI + MCP server); no HTTP serve bin. Imported by #161; aggregate task (todos ee9fbb4d)." },
...
export const SDK_EXCEPTIONS: Array<{ member: string; reason: string }> = [
  ...
  { member: "otp", reason: "SDK lane (c7ce8b75); no ./sdk export yet. Imported by #161." },
...
export const MANIFEST_MISSING_EXCEPTIONS: Array<{ member: string; reason: string }> = [
  ...
  { member: "otp", reason: "No hasna.contract.json; imported by #161 after the original census; manifest lane (todos 41208cbe)." },
];
