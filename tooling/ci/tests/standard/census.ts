...
export const SERVE_EXCEPTIONS: Array<{ member: string; reason: string }> = [
  ...
  { member: "uptime", reason: "CLI/MCP-shaped member (uptimemon CLI + MCP server); no HTTP serve bin. Imported by #157; aggregate task (todos ee9fbb4d)." },
...
export const MANIFEST_MISSING_EXCEPTIONS: Array<{ member: string; reason: string }> = [
  ...
  { member: "uptime", reason: "No hasna.contract.json; imported by #157 after the original census; manifest lane (todos 41208cbe)." },
];
